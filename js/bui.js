...
!function(e) {
    ...
    function(e, t) {
        ...
        e.option = function(n, i) {
            if ("object" !== e.typeof(n) && void 0 === i)
                return "string" == typeof n ? this.config[n] : this.config;
            if ("id" == n)
                return e.showLog("不允许修改控件的ID参数"),
                this;
    ...
    function(e, t) {
        e.emitter = function() {
            ...
            t.prototype.off = function(t, n, i) {
                ...
                n = this) : "function" == typeof i ? (i = i,
                n = n || this) : n = this;
                var a = e.typeof(t);
                if (void 0 === t)
                    n.handle = Object.create(null);
                ...
                try {
                    for (var e in this.handle)
                        if (this.handle[e]instanceof Array)
                            for (var t = this.handle[e], n = 0, i = t.length; n < i; n++)
    ...
    function(e, t) {
        e.store = function(n) {
            ...
            function r(n) {
                ...
                var r = t.extend(!0, {}, i, e.config.store);
                return function e(n) {
                    var o = 0;
            ...
            var l = "function" == typeof (a = r(n)).data ? a.data.call(_) : a.data
              ...
              , p = a.watch || i.watch;
            a.delayInput;
            var h, g = a.isPublic, m = a.modelEvent, v = a.needStatic, b = "", y = !1, w = !0, x = {}, k = {}, I = {}, T = !1, O = {}, C = e.emitter(), P = {
                target: null
            };
              ...
              , _ = {
                ...
                setState: function(n, i) {
                    ...
                    r && void 0 !== i) {
                        ...
                        s = i && "object" === e.typeof(i) ? t.extend(!0, {}, h, i) : i,
                        p && (d = n.replace(/\.\d$/, ""),
                        f = e.unit.getKeyValue(d, D)),
                        e.unit.setKeyValue(n, s, l),
                        e.unit.setKeyValue(n, s, D),
                        p) {
                ...
                connect: function(t, n, i) {
                    if ("object" !== _typeof(t) || !t.hasOwnProperty("$refs"))
                        return _;
                    var a = this;
                    if ("string" == typeof n) {
                        he(t, n);
                        ...
                        for (var r = Object.keys(D), l = 0; l < r.length; l++) {
                            var c = r[l];
                            if (e.array.compare(pe, c, "field"))
                                break;
                            if (he(t, c),
                            t.$data.hasOwnProperty(c)) {
                                t.$data[c];
                                var s = a.$data[c];
                    ...
                    function u(n, i, a) {
                        ...
                        var r = e.array.index(pe, n, "field");
                        (r < 0 || pe[r] && t.$options.el !== pe[r].el) && pe.push({
                            field: a || n,
                            el: t.$options.el,
                            disconnect: o
                        })
                    ...
                    function d(n, o, r) {
                        ...
                        _defineProperty(l, "keyname", n),
                        _defineProperty(l, "origin", D),
                        l))
                    }
                    return _
                },
            ...
            function z() {
                ...
                for (var o in j = "object" === _typeof(a.el) ? t(a.el) : i.length ? i : t(a.el),
                L = j && j.parent(),
                E = j && j.children(),
                _.$el = j,
                _.$parent = L,
                    ...
                    var e = function(e) {
                        Object.defineProperty(_, e, {
                            ...
                            get: function() {
                                ...
                                w = !1);
                                var t = l[e];
                                return Array.isArray(t) && P.target && (Array.isArray(x[e]) || (x[e] = []),
                                x[e].push(P.target)),
                                t
                            },
                            set: function(t) {
                        ...
                        Object.keys(s).forEach((function(t) {
                            if (l.hasOwnProperty(t))
                                ...
                                Object.defineProperty(_, t, {
                                    ...
                                    set: n && "object" === e.typeof(n) && n.set || function() {}
                                })
                            }
                        }
                        ))
            ...
            function q(n) {
                try {
                    var i = null
                      , o = null;
                    void 0 === n ? (i = j,
                    o = a) : "string" == typeof n ? (i = S(n),
                    o = a) : n && "object" === _typeof(n) && (i = S(n) || t(n),
                    o = t.extend(!0, {}, a, n));
                    var r = !0;
            ...
            function W() {
                return j.find("[ref]").each((function() {
                    var t = this.getAttribute("ref")
                      ...
                      , i = null;
                    n && "htmldivelement" === e.typeof(O[t]) ? ((i = [O[t]]).push(this),
                    O[t] = i) : n && "array" === e.typeof(O[t]) ? O[t].push(this) : O[t] = this
                }
                )),
                this
            }
            ...
            function Y(t, n) {
                var i;
                return U && U.hasOwnProperty(t) ? i = U[t] : (void 0 === (i = e.unit.getKeyValue(t, n)) && R && console.warn("请检查 ".concat(t, " 在bui.store scope:").concat(c, " 中有没有声明定义")),
                U[t] = i),
                i
            }
            function J(n) {
            ...
            function Z(n) {
                ...
                function l(t) {
                    var n = t.target.value
                      ...
                      , a = i[0] && i[0].keyname || "";
                    if ("" === a)
                        return e.showLog("b-model的值不能为空"),
                        !1;
                    ge(a, n),
                    N = [],
                    t.stopPropagation()
                ...
                i.off("change", s).on("change", s, (function(t) {
                    try {
                        var n, a = this, o = this.getAttribute("value") || this.checked, r = this.getAttribute("type"), l = ue.call(this, "b-model")[0].keyname, s = this.getAttribute("check-value"), u = this.getAttribute("uncheck-value"), d = this.getAttribute("check"), f = this.getAttribute("uncheck");
                        (d || f || s || u) && (o = this.checked ? s || this.value || d : u || f || ""),
                        n = Y(l, _);
                        var p = /\{.+\}$/g.test(o) ? null : i.find('[type="checkbox"][b-model="'.concat(c + "." + l, '"][value="').concat(o, '"],\n                [type="radio"][b-model="').concat(c + "." + l, '"][value="').concat(o, '"]'));
                        switch (r) {
                        case "checkbox":
                            this.checked && (n && "array" === e.typeof(n) ? !e.array.compare(n, o) && e.unit.getKeyValue(l, _).push(o) : ge(l, o),
                            this.checked = !0),
                            this.checked || (n && "array" === e.typeof(n) ? e.array.remove(e.unit.getKeyValue(l, _), o) : ge(l, o),
                            this.checked = !1),
                ...
                i.off("change", u).on("change", u, (function(n) {
                    try {
                        ...
                        a) {
                        case !0:
                            "array" !== e.typeof(r) && e.showLog("".concat(o, "的类型必须为数组")),
            ...
            function Q(e) {
                var t = e;
                ["b-click", "b-mousedown", "b-mouseover", "b-mouseup", "b-touchstart", "b-touchmove", "b-touchend", "b-submit", "b-change", "b-scroll", "b-keydown", "b-keyup", "b-keypress", "b-focus", "b-blur"].forEach((function(e, n) {
                    var i = e.substr(2);
                            ...
                            be(d, (function(t) {
                                try {
                                    ...
                                    if (f && f.hasOwnProperty(r)) {
                                        ...
                                        void 0 === o && (o = "",
                                        e.showLog("".concat(r, "模板方法需要返回内容，例如：return html;"))),
                                        ...
                                        case "push":
                                            ...
                                            y && y == v.length)
                                                ...
                                                for (var w = b.length, x = w; x < v.length; x++)
                                                    J({
                                                        el: v.eq(w + x - 1),
                                                        action: "push"
                                                    });
                                        ...
                                        !function(t) {
                                            ("string" == typeof t ? e.$(t).find("component") : t.find("component")).each((function(e, t) {
                                                loader.component({
                                                    id: t
                                                })
                                            }
                                        ...
                                        e.showLog("找不到对应的模板,请检查下 scope:".concat(c, " 的templates是否存在").concat(r), "bui.store")
                                } catch (t) {
                                    e.showLog(t)
                                }
                            }
            ...
            function le(e) {
                ...
                e.param;
                var a = this;
                if ("SELECT" === this.nodeName && this.multiple)
                    e.value.length > 1 ? e.value.forEach((function(e, n) {
                    ...
                    case "checkbox":
                        if (i && e.value instanceof Array)
                            ...
                            e.value === i || 1 == e.value ? this.checked = !0 : this.checked = !1;
                        break;
                    default:
                        if (event && event.target && "INPUT" === event.target.nodeName)
                            break;
                        this.value = e.value
                    }
                    N = []
            ...
            function se(e, t, n, i) {
                "boolean" == typeof n ? (n && e.addClass(t),
                !n && e.removeClass(t)) : "string" == typeof n ? (g && e.removeClass(n),
                i && e.removeClass(i),
                n && !e.hasClass(n) && e.addClass(n),
                void 0 !== i && "" === n && e.removeClass(i)) : (Boolean(n) && e.addClass(t),
                !Boolean(n) && e.removeClass(t))
            }
            function ue(t) {
                var n = []
                  , i = this
            ...
            function de(n, i) {
                try {
                    var a = n ? n.match(/([^\(|\)]+)/g) : []
                      ...
                      , v = ""
                      , b = "";
                    if (h = (h = (s = a[0] && a[0].indexOf(c + u) > -1 ? a[0].split(c + u) : [c, a[0]])[0].split(c))[0] || h[1] || "",
                    r = c,
                    (l = s[1] || "").indexOf("$index") > -1) {
                        var y = t(g).index();
                        l = l.replace("$index", y)
                    ...
                    if (void 0 !== a[1]) {
                        var O, C = (O = t(g).attr("b-target")) && t(g).closest(O)[0] || g, P = a[1].replace(/\$index/g, t(C).index()) || "";
                        try {
                            var S = /\{.+\}$/g
                              , j = /\[.+\]$/g
                    ...
                    void 0 !== a[2] && (v = (f = a[2].indexOf(".") > -1 ? a[2].split(".") : [a[2]])[0],
                    b = f[1] || "")
                } catch (t) {
                    e.showLog("参数格式错误:" + n)
                }
            ...
            function fe(n, i) {
                if (!n || !n.hasOwnProperty("widget") || "function" != typeof n.widget)
                    return function(n, i) {
                        ...
                        function s(n, i) {
                            ...
                            if (function(n, i) {
                                ...
                                Object.defineProperty(n, i, {
                                    ...
                                    set: function(n) {
                                        ...
                                        s instanceof Array ? fe(l, N) : "object" === e.typeof(s) && (a.deep && fe(n),
                                        s && Object.keys(s).forEach((function(e, t) {
                                            var n = i + "." + e;
                                            N = [],
                                            xe(n, {
                                                target: null,
                            ...
                            r instanceof Array && function(t, n) {
                                var i = []
                                  , o = Array.prototype
                                  , r = Object.create(o);
                                    ...
                                    Object.defineProperty(r, t, {
                                        ...
                                        value: function(o) {
                                            ...
                                            var u = i.join(".")
                                              , d = this.slice(0)
                                              , f = s.apply(this, r);
                                            switch (R && console.log("5. ".concat(u, " action ").concat(t, ", param:").concat(r, " ")),
                                            t) {
                                            case "pop":
                                            case "shift":
                                                r = [f]
            ...
            function he(t, n) {
                ...
                return !!(i > -1 && pe[i] && t.$options.el === pe[i].el) && (pe[i].disconnect && pe[i].disconnect(),
                !0)
            }
            function ge(n, i) {
                ...
                o && void 0 !== i ? (R && console.log("set ".concat(n, " ")),
                T = !0,
                xe.call(_, "beforeupdate", (_defineProperty(c = {
                    action: "set",
                    target: null,
                    value: r,
                    preValue: d
                }, "action", "set"),
                _defineProperty(c, "keyname", n),
                _defineProperty(c, "origin", D),
                c)),
                a.beforeUpdates.forEach((function(e, t) {
                    var i;
                    ...
                    _defineProperty(i, "keyname", n),
                    _defineProperty(i, "origin", D),
                    i))
                }
                )),
                i && "object" === e.typeof(i) ? (r = t.extend(!0, {}, d, i),
                ...
                e.unit.setKeyValue(n, r, l),
                e.unit.setKeyValue(n, r, D),
                xe.call(_, n, {
                    target: null,
                    value: r,
                    preValue: d,
                ...
                _defineProperty(s, "keyname", n),
                _defineProperty(s, "origin", D),
                s)),
                a.updateds.forEach((function(e, t) {
                    var i;
                    e.call(_, (_defineProperty(i = {
                ...
                "object" === _typeof(i) && (i instanceof Array ? fe(l, n.split(u)) : fe(i)),
                N = []) : n && "object" === e.typeof(n) && (D = t.extend(!0, {}, D, n),
                ve(n));
                return D
            }
            function me(t, n) {
                return function(t, n) {
                    "string" == typeof t && (e.unit.delKey(t, D),
                    n && n.call(_, t))
                }(t, (function(e) {
                    xe(t)
                }
            ...
            function ye(e, t) {
                return I.hasOwnProperty(e) || (be(e, t),
                I[e] = t),
                this
            }
            function we(e, t) {
    ...
    function(e, t) {
        e.viewport = function(n, i) {
            ...
            var a, o = t.extend(!0, {
                ...
                size: 0,
                create: !1
            }, e.config.viewport), r = "object" == _typeof(n) ? t.extend(!0, o, n) : o, l = document.querySelector("meta[name=viewport]"), c = "width=".concat(r.width, ", initial-scale=").concat(r.initScale, ", maximum-scale=").concat(r.maxScale, ", minimum-scale=").concat(r.minScale, ", user-scalable=").concat(r.scalable, ",viewport-fit=").concat(r.fit), s = window.devicePixelRatio, u = document.documentElement.clientWidth, d = document.documentElement.clientHeight, f = parseInt(u) * parseInt(s), p = parseInt(d) * parseInt(s);
            if (u = u > d ? d + 24 : u,
            r.size = "number" == typeof n ? n : r.size || (u / r.base * 100).toFixed(2),
            l)
                r.create && (l.content = c);
            else {
    ...
    function(e, t) {
        e.loader = function(n) {
            var i, o = t.extend({}, {
                ...
                deepComponent: !0,
                scriptSuffix: ".js"
            }, e.config.loader, n), r = e.emitter(), l = [], c = [], s = {}, u = {
                baseUrl: "",
                modules: {},
                globals: {}
            }, d = {}, f = {
                ...
                define: function(n, i, a) {
                    ...
                    var h = [];
                    if (void 0 === n)
                        return e.showLog("define第1个参数不能为空"),
                        this;
                    "function" == typeof n ? (a = n,
                    c = f,
                    i = []) : "object" === e.typeof(n) ? (c = f,
                    i = n.depend || [],
                    a = n.loaded,
                    l = t.extend(!0, {}, r, n)) : "array" === e.typeof(n) ? (a = i,
                    i = n,
                    c = f) : "function" == typeof i ? (c = n,
                    a = i,
                    i = []) : (c = n,
                    i = i,
                    a = a);
                    ...
                    if ("string" == typeof c && "function" == typeof a) {
                        (l = n && "object" === e.typeof(n) ? t.extend(!0, {}, r, d[c], e.config.loader.define, n) : t.extend(!0, {}, r, d[c], e.config.loader.define)).moduleName = c,
                        l.depend = h,
                        l.style = [],
                        l.script = g,
                ...
                delay: function(n) {
                    for (var i = t.extend(!0, {
                        ...
                        var l = a[r]
                          ...
                          , s = l && l.tagName.toLowerCase();
                        ("true" === c || i.everytime) && ("true" === c && s === o.componentTag || i.everytime ? (i.isSelf = !0,
                        i.id = l,
                        i.everytime ? l.removeAttribute("delay") : l.setAttribute("delay", "false"),
                        k(i)) : "true" === c && s === o.viewTag || i.everytime ? (i.isSelf = !0,
                        i.id = l,
                        l.removeAttribute("delay"),
                        P(i)) : (i.isSelf = !1,
                        s = t(l).find('[delay="true"]')[0] && t(l).find('[delay="true"]')[0].tagName.toLowerCase(),
                        t(l).find('[delay="true"]').removeAttr("delay"),
                        s === o.componentTag && k(i),
                        s === o.viewTag && P(i)))
                    }
                    return this
                },
            ...
            function p(n) {
                if (void 0 === n)
                    return u;
                if ("object" === _typeof(n) && (n.hasOwnProperty("modules") || n.hasOwnProperty("baseUrl") || n.hasOwnProperty("globals")))
                    u = t.extend(!0, {}, u, n),
                    d = u.modules;
                    ...
                    var i = function(n) {
                        var i = {
                          ...
                          , a = {};
                        d.hasOwnProperty(n.moduleName) && (a = t.extend(!0, {}, d[n.moduleName]));
                        var o = t.extend(!0, {}, i, a, n);
            ...
            function h(t, n) {
                if (n && "object" === e.typeof(n)) {
                    if (n.moduleName = t,
                    n.hasOwnProperty("loaded") && "function" == typeof n.loaded) {
                        var i = n.loaded;
                        n.loaded = function() {
                            d = u.modules;
                            var e = n.moduleName
            ...
            function m(e, t) {
                for (var n = [], i = 0; i < e.length; i++) {
                    ...
                    if (o.indexOf(".css") > -1)
                        o.indexOf("css!") > -1 ? styles.push(o.substr(4)) : styles.push(o);
                    else {
                        var r = o.indexOf(".js");
                        r > -1 && (o = o.substr(0, r)),
                        n.push(o),
            ...
            function v() {
                var e, n = window.location.href, r = [], l = document.currentScript;
                if (n.indexOf("#") > -1 ? r = n.split("#") : r.push(n),
                i = r[0].replace("/index.html", "") + "/",
                l)
                    return e = l.src.replace(i, ""),
                    {
            ...
            function b(t, n, i) {
                if (o.log && console.log("require " + t),
                i = 1 == i,
                ...
                if (n && "function" != typeof n && "boolean" != typeof n)
                    return e.showLog("require第2个参数格式为函数或布尔值", "bui.loader.require"),
                    this;
                try {
                    return function(t, n, i) {
                        ...
                        function r(t, n) {
                            ...
                            i.length > 1 && i.forEach((function(e, t) {
                                var n = d[e];
                                (n && 1 == n.isLoaded || n.loaded) && i.splice(t, 1)
                            }
                            )),
                            i.forEach((function(t, l) {
                                var c = d[t];
                                if (d[t] && d[t].style && d[t] && d[t].style.length && N(d[t].style),
                                e.array.compare(a, t) || a.unshift(t),
                                c && c.isLoaded) {
                                    if (!1 === (c && c.beforeLoad && c.beforeLoad.call(c, c.depend)))
                                        return !1;
                                    l == i.length - 1 && (n && n.apply(c),
                                    a = [])
                                } else if (c && c.loaded) {
                                    if (s(t, l),
                                    !1 === (d[t].beforeCreate && d[t].beforeCreate.call(d[t])))
                                        return !1;
                                    d[t].created && d[t].created.call(d[t])
                                } else
                                    E(t, (function() {
                                        var e = d[t];
                                        if (!1 === (e && e.beforeCreate && e.beforeCreate.call(d[t])))
                                            return !1;
                                ...
                                function s(e, t) {
                                    ...
                                    a.id = c ? c.id : "",
                                    a.props = c ? c.props : {},
                                    !1 !== (a && a.beforeLoad && a.beforeLoad.call(a, a.depend)) && (a && a.depend && a.depend.length ? (o.log && console.warn(a.moduleName + " depend:"),
                                    o.log && console.log(a.depend),
                                    void r(a.depend, n)) : void (t == i.length - 1 && n && n.apply(a)))
                                }
                            }
                            ))
                        }
            ...
            function w(n) {
                ...
                if (i.id) {
                    if (i.url) {
                        if (!1 === ("function" == typeof i.beforeLoad ? i.beforeLoad.call(f) : i.beforeLoad))
                            return this;
                        var o = function(e) {
                            var t = d
                              , n = {}
                              , i = e && e.indexOf(".html");
                            i > -1 ? (n.url = e,
                            n.module = e.substr(0, i)) : (n.url = t[e] && t[e].template || e + ".html",
                            n.module = e);
                            return n
                        }(i.url);
                        if (i.script) {
                        ...
                        return S(o.url, (function(t) {
                            !i.cacheHtml && e.obj(i.id).html(t),
                            x(i)
                        }
                        ), (function(e) {
            ...
            function x(n) {
                ...
                if (!1 === (i.beforeLoad && i.beforeLoad.call(i, i.depend)))
                    return !1;
                if (h(n.name, {
                    id: n.id,
                    props: n.param || null,
            ...
            function k(n) {
                ...
                l.length ? (j(e.array.merge(c, s), (function(e) {
                    !function t(n) {
                        var a = l[n];
                        return n == l.length ? (i.data = l,
                        T(i),
                        this) : a ? (a.template = e[n],
                        void w({
                            id: a.id,
                            url: a.url,
                            param: a.param || null,
                ...
                this) : (i.compiled && i.compiled(i.data),
                D("componentcompiled", i.data),
                !1)
            }
            function I(e) {
                return k(t.extend(!0, {
            ...
            function S(n, i, a) {
                return new Promise((function(o, r) {
                    if ("string" == typeof n)
                        (n = e.unit.resolvePath(n)).indexOf(".css") > -1 ? (i && i(n),
                        B(n).then((function(e) {
                            o(n)
                        }
            ...
            function L(t, n, i) {
                return new Promise((function(a, r) {
                    ...
                    if (t = e.hasRouter ? t : e.unit.relativePath(t, o.relativePath),
                    s.hasOwnProperty(t))
                        return l ? n && n.call(f, s[t], 200) : "string" == typeof n && e.$(n).html(s[t]),
                        a(s[t], 200),
                        this;
                    "string" == typeof t && bui.ajax({
                        ...
                        success: function(o, r, c) {
                            s[t] = o,
                            l ? n && n.call(f, o, r, c) : "string" == typeof n && (e.$(n).html(o),
                            i && i.call(f, o, r, c)),
                            a(o, r)
                        },
            ...
            function E(n, i, a) {
                return new Promise((function(r, c) {
                    ...
                    return d[s] && d[s].isDefined ? (i && i(n),
                    r(n)) : (m > -1 && d.hasOwnProperty(s) && t('script[name="' + s + '"]').remove(),
                    m > -1 && !d.hasOwnProperty(s) && t('script[name="' + s + '"]').remove(),
        ...
        e.toggle = function(n) {
            ...
            var a, o, r = {
                show: function(t, n) {
                    ...
                    "showIn" == n || "showOut" == n || "none" == n ? (l.revert && d.removeClass("animated " + n),
                    t && t.call(r, this),
                    h = !0,
                    f = !0) : d.one("webkitAnimationEnd", (function() {
                        try {
                            !h && d.css("display", c),
                ...
                hide: function(t, n) {
                    ...
                    "showIn" == n || "showOut" == n || "none" == n ? (d.css("display", "none"),
                    l.revert && d.removeClass("animated " + n),
                    t && t.call(r, this),
                    h = !1,
                    p = !0) : d.one("webkitAnimationEnd", (function() {
                        try {
                            d.css("display", "none"),
                            l.revert && d.removeClass("animated " + n),
                            t && t.call(r, this),
                ...
                revert: !0,
                inOrder: !1
            }, n), c = l.useBox ? "-webkit-box" : "block", s = !1, u = {
            ...
            function g(t) {
                ...
                (t = t || l).id) {
                    ...
                    c < 0 ? (o = u.show[0],
                    a = t.inOrder ? u.hideInOrder[0] : u.hide[0]) : (o = u.show[c],
                    a = t.inOrder ? u.hideInOrder[c] : u.hide[c]),
    ...
    function(e, t) {
        ...
        e.unit.openExtral = function(t) {
            var n = []
              , i = "";
            if ((t = String(t)).indexOf("mailto:") >= 0)
                if ((i = (n = t.split("mailto:"))[1]).indexOf("?") > -1) {
                    var a = i.split("?")
            ...
            if (t.indexOf("tel:") >= 0 && (n = t.split("tel:"),
            i = parseInt(n[1]),
            e.unit.tel(i)),
            t.indexOf("sms:") >= 0)
                if (i = (n = t.split("sms:"))[1],
                t.indexOf("=") >= 0) {
                    var r = t.split("=")[1];
                    e.unit.sms(i, r)
                } else
        ...
        e.unit.checkTargetInclude = function(e, n) {
            ...
            if (i.indexOf(",") > -1) {
                ...
                i.indexOf(".") > -1 ? a[0] = i.substr(1) : a[0] = i;
            var c, s = a.length;
            for (c = 0; c < s; c++)
                if (t(e).hasClass(a[c]) || t(e).closest("." + a[c]).length)
                    return !0;
            return !1
        }
        ,
        e.unit.jsonToString = function(t) {
            return "object" === _typeof(t) ? function(t) {
                var n;
                if ("object" === e.typeof(t)) {
                    ...
                    "array" === e.typeof(t) ? (t.forEach((function(e, n) {
                        t[n] = a(t, n)
                    }
                    )),
        ...
        e.unit.stringToJson = function(t) {
            return t && function t(n) {
                var i, a;
                try {
                    if (i = "object" === _typeof(n) ? n : JSON.parse(n),
                    "array" === e.typeof(i))
                        i.forEach((function(e, n) {
                            i[n] = t(e)
                        }
                        ));
                    else if ("object" === e.typeof(i))
                        for (var o in i) {
                            var r = i[o];
                            i[o] = t(r)
                        }
        ...
        e.unit.getKeyValue = function(e, t) {
            ...
            return function e(t, i) {
                var a = i[t];
                if (a && "string" == typeof a && a.indexOf("{") > -1 && a.indexOf("}") > -1)
                    try {
                        i[t] = JSON.parse(a)
                    } catch (e) {
                        i[t] = a
        ...
        e.unit.delKey = function(e, t) {
            ...
            return function e(i, a) {
                return n.length ? e(n.shift(), a[i]) : (delete a[i],
                t)
            }(n.shift(), t)
        }
        ,
        ...
        e.unit.relativeUrl = function(e, t) {
            ...
            return t.length >= e.length ? t.forEach((function(t, i) {
                var a = e[i];
                a && t === a || (a && t !== a ? (n.unshift(".."),
                n.push(t)) : n.push(t))
            }
            )) : e.forEach((function(e, i) {
                var a = t[i];
                a && e === a || (a && e !== a ? (n.unshift(".."),
                n.push(a)) : n.unshift(".."))
            }
            )),
            n
        ...
        e.unit.relativePath = function(t, n) {
            ...
            if (i.indexOf("source.html?url=") > -1 && i.indexOf("code=") > -1)
                return t;
        ...
        e.unit.between = function(t, n, i) {
            var a = !0
              , o = new Date;
            if (n = n || 0,
            i = i || e.date.convert(o.getFullYear + "/12/31").getTime(),
            "number" == typeof t)
                (t < n || t > i) && (a = !1);
            else {
    ...
    function(e, t) {
        ...
        o = {
            ...
            getPage: function(t, n) {
                if (void 0 !== t) {
                    ...
                    if (o.hasOwnProperty(t))
                        ...
                        for (var r = Object.keys(o), l = 0; l < r.length; l++) {
                            var c = o[r[l]] || {};
                            if (c.name === t)
                                return c[n]
                        }
            ...
            setPage: function(n) {
                ...
                if (n && n.hasOwnProperty("id")) {
                    var a, o = t.extend(!0, {}, i.page[n.id], n);
                    for (a in o.param)
                        o.param[a] && "array" == e.typeof(o.param[a]) && (o.param[a] = n.param[a] || []);
            ...
            removeNext: function(t) {
                var n = a
                  , i = t.index;
                if (parseInt(i) < 0)
                    return e.showLog("index 必须大于或者等于0"),
                    n;
                var o = n.length - i;
                n.splice(i, o);
                var r = this.getLast()
        ...
        n = function(t) {
            ...
            return n > -1 ? (o = (a = 0 == t.indexOf("/") ? t.substr(1, n - 1) : t.substr(0, n - 1)) + ".html",
            r = a + ".js") : (o = c[a = t] && c[a].template || "",
            r = c[a] && c[a].script || ""),
            {
                pid: a,
                name: a,
    ...
    function(e, t) {
        e.router = function(n) {
            var i, a, o, r = t.extend({}, {
                ...
                scriptSuffix: ".js",
                pageSuffix: ".html"
            }, e.config.router, n), l = null, c = this, s = null, u = null, d = null, f = "", p = "", h = !0, g = !0, m = !1, v = !1, b = {
                none: {
                    inRight: "showIn",
                    inLeft: "showIn"
                },
            ...
            }, y = {}, w = {}, x = {}, k = {}, I = !1, T = {}, O = {}, C = loader.map(r.indexModule), P = e.history.epmty(), S = C.modules, j = e.storage({
                local: !1
            });
            function L(e) {
            ...
            function E(n) {
                ...
                var k = c.replace || c.part ? g.id : c.id || e.guid()
                  , C = e.objId(k);
                if (!c.url)
                    return e.showLog("url 不能为空", "bui.router.load"),
                    f.promise();
                if (c.url = c.decode ? decodeURIComponent(c.url) : c.url,
                c.url.indexOf("tel:") >= 0 || c.url.indexOf("mailto:") >= 0 || c.url.indexOf("sms:") >= 0)
                    return e.unit.openExtral(c.url),
                    f.promise();
                ...
                q.currentComponent = k,
                P.splice(P.length - 1, 1, q)),
                c.part || H,
                x[B])
                    !function(e) {
                ...
                function W(t, n, i, l) {
                    ...
                    f.reject(t),
                    "object" === _typeof(n))
                        return e.showLog("找不到页面" + t, "bui.router.load"),
                        r.errorPage && function(e) {
                            !function(e) {
                                var t, n = window.location.href, i = (t = (t = n.indexOf(r.hashPrefix)) > -1 ? t : 0) > -1 ? n.substr(0, t) : n;
                                E({
                                    url: r.errorPage || i,
                                    param: {
                                        error: e
                ...
                function K(n) {
                    ...
                    I && J(),
                    n && n(),
                    r.needComponent && loader.components()) : (loader.checkLoad(B) ? (Z({
                        pid: B
                    }),
                    r.needComponent && loader.components(),
                    n && n()) : (r.needComponent && loader.components(),
                    loader.require(B, (function(t) {
                        try {
                            if (c.firstAnimate && c.progress && a && a.hide(),
                            y[B] = t || null,
                            H.exports = t,
                            f.resolve(t),
                            h || c.firstAnimate || c.replace) {
                                var i = loader.get(B);
                                i && i.show && i.show({
                                    type: "firstload",
                                    target: H
                ...
                function X(t) {
                    ...
                    if (t = t.replace(/#module\.id/g, "#" + i.id),
                    c.part)
                        n = U({
                            content: t
                        }),
            ...
            function N(e) {
                ...
                return i > -1 ? (n = (t = n).substr(0, i),
                S.hasOwnProperty(n) && (t = S[n] && S[n].template || t || "")) : t = S[n = n] && S[n].template || n + r.pageSuffix || "",
                {
                    pid: n,
                    url: t
                }
            ...
            function D(t) {
                var n, i = e.array.indexs(P, t, "pid"), a = i.length;
                if (a) {
            ...
            w.add = function(n) {
                ...
                if (!h)
                    return r.syncHistory && "pushState"in window.history && window.history.pushState(n, null, o),
                    P;
            ...
            w.replace = function(t) {
                ...
                return n > -1 && (P.splice(n, 1, t),
                r.syncHistory && "replaceState"in window.history && window.history.replaceState(t, null, a)),
                P
            }
            ,
            ...
            var z = {
                init: function(n) {
                    ...
                    delete n.store,
                    n = t.extend(!0, {}, r, e.config.router, n),
                    r = z.config = n;
                    ...
                    if ("pages/main/main.html" === n.indexModule.template && "pages/main/main.js" === n.indexModule.script || (C = loader.map(n.indexModule)),
                    v && "effect"in n && P.forEach((function(e, t) {
                        e.effect = n.effect
                    }
                    )),
                    !n.id)
                        return e.showLog("id 不能为空", "bui.router.init"),
                        !1;
                    if (i = e.objId(n.id),
                    o = bui.mask({
                        appendTo: i,
                    ...
                    s = i.children(".bui-router-main"),
                    f = n.width || window && window.viewport && window.viewport.width() || document.documentElement.clientWidth || "100%",
                    p = n.height || window && window.viewport && window.viewport.height() || document.documentElement.clientHeight || "100%",
                    !s.length) {
                        var g = (l = "",
                        String(f).indexOf("%"),
                        String(p).indexOf("%"),
                        l += '<div class="bui-router-main">',
                        l += "</div>");
                        i.html(g),
                        s = i.children(".bui-router-main")
                    }
                    ...
                    function(n) {
                        if (function() {
                            ...
                            Boolean(t) && r.reloadCache ? T.load() : function(t) {
                                try {
                                    var n = L();
                                    if (n.pid) {
                                        if (n.pid.indexOf("http://") > -1 || n.pid.indexOf("https://") > -1)
                                            return n.param.iframe = !0,
                                            void E({
                                                url: n.pid,
                                                param: n.param,
                                                iframe: !0
                        ...
                        n.swipe && function(n) {
                            ...
                            i.on("touchstart", (function(i) {
                                ...
                                P.length > 1 && f.x1 > 0 && f.x1 < n.distance && (u = t("#".concat(w.getLast().id)),
                                d = e.history.getPrev().id ? t("#".concat(e.history.getPrev().id)) : null)
                            }
                            )),
                            i.on("touchmove", (function(i) {
                                ...
                                f.x2 = p.pageX,
                                f.y2 = p.pageY,
                                a.length > 1 || i.scale && 1 !== i.scale || (s = t(i.target).closest(r.useScroll).length,
                                f.x2 - f.x1 > 0 && !s && i.preventDefault(),
                                f.direction || (f.direction = e.swipeDirection(f.x1, f.x2, f.y1, f.y2)),
                                "swipeleft" !== f.direction && "swiperight" !== f.direction || (i.preventDefault(),
                                i.stopPropagation()),
                                l = Math.abs(f.x2 - f.x1),
                                c = Math.abs(f.y2 - f.y1),
                                "swiperight" === f.direction && l > n.startDistance && n.swipeBack && (d && d.css("display", "block"),
                                n.pageMove && u && u.css("transform", "translateX(".concat(l, "px)")),
                                i.preventDefault()))
                            }
                            )),
                            i.on("touchend", (function(e) {
                                (s = t(e.target).closest(r.useScroll).length,
                                "swiperight" === f.direction && f.x1 > n.distance && n.swipeBack && (l = 0),
                                "swiperight" === f.direction && l > n.swipeDistance) && (!1 !== (n.onBeforeSwipeRight && n.onBeforeSwipeRight()) && n.swipeBack && bui.back(),
                                n.onSwipeRight && n.onSwipeRight(e),
                                _.call(z, "swiperight"));
                                "swipeleft" === f.direction && l > n.swipeDistance && (n.onSwipeLeft && n.onSwipeLeft(e),
                                _.call(z, "swipeleft")),
                                "swipeup" === f.direction && c > n.swipeDistance && !s && (n.onSwipeUp && n.onSwipeUp(e),
                                _.call(z, "swipeup")),
                                "swipedown" === f.direction && c > n.swipeDistance && !s && (n.onSwipeDown && n.onSwipeDown(e),
                                _.call(z, "swipedown")),
                                l < n.swipeDistance && (d && d.css("display", "none"),
                                u && u.css("transform", "translateX(0)")),
                                l = 0,
                                s = !1,
                                f = {
                                    x1: 0,
                ...
                destroy: function(t) {
                    return "string" == typeof t && "main" !== t ? (loader.destroy(t),
                    T.del(t),
                    t in y && delete y[t]) : e.showLog("参数只能是字符串"),
                    this
                },
                loadPart: function(e) {
                    var n = t.Deferred()
    ...
    function(e, t) {
        var n = function() {
            function n(i) {
                ...
                this.config = t.extend(!0, {}, this._default, a, this._plugin.config, this._plugin.param),
                this.initStatus = !1,
                this.reinitStatus = !1,
            ...
            return _createClass(n, [{
                ...
                value: function(n) {
                    ...
                    !1 === r || (i._plugin.callback && i._plugin.callback.call(i, o),
                    o.log && console.log("".concat(i._plugin.name, " init")),
                    o.hasLife && o.onInited && o.onInited.call(i, o),
                    o.log && console.log("".concat(i._plugin.name, " after inited")),
                    this.initStatus = !0,
                    i.config.uid && e.history.setUI && e.history.setUI({
                        uid: i.config.uid,
                        ui: i
                    })),
                    i
    ...
    t((function(e) {
        !function(t, n) {
            ...
            t.extend({
                ...
                _defineProperty(i, "effect", "fadeInRight"),
                _defineProperty(i, "onError", null),
                _defineProperty(i, "beforeClose", null),
                _defineProperty(i, "closed", null),
                _defineProperty(i, "beforeOpen", null),
                _defineProperty(i, "opened", null),
                _defineProperty(i, "beforeLoad", null),
                _defineProperty(i, "loaded", null),
                i),
                callback: function(i) {
                    var a = this
                      , o = a.config
                      ...
                      , l = ""
                      , c = !1
                      , s = (loader.map().modules,
                    a.widgets.dialog = t.dialog({
                        autoinit: !1,
                    ...
                    function g(e) {
                        ...
                        return i > -1 ? (n.url = e,
                        n.module = e.substr(0, i)) : (n.url = t[e] && t[e].template || e + o.pageSuffix,
                        n.module = e),
                        n
                    }
                    a.init = function(e) {
                        var i = n.extend(!0, {}, a.config, e);
                        ...
                        return !1 === (i.beforeLoad && i.beforeLoad.call(a, u)) ? this : (loader.import(u.url, (function(e) {
                            "object" !== _typeof(e) ? (l = f(e, i),
                            i.id ? (s.init(i),
                            r(i.id).html(e)) : (i.content = e,
                            s = s.create(i)),
                            i.autoload && a.open(),
                            i.loaded && i.loaded.call(a, u)) : i.onError && i.onError.call(a, e)
                        }
                        )),
                        a)
                    }
                    ...
                    a.reload = function(e) {
                        ...
                        if (!1 === (t.beforeLoad && t.beforeLoad.call(a, u)))
                            return this;
                        loader.import(u.url, (function(e) {
                            "object" !== _typeof(e) ? (l = f(e, t),
                            r("#" + (s.config.id || t.dialogid)).html(l),
                            h(u.module),
                            t.loaded && t.loaded.call(a, u)) : t.onError && t.onError.call(a, e)
                        }
                        ))
                    }
                    ,
                    ...
                    a.isOpen = s.isOpen,
                    a.close = function(e) {
                        return !1 === (i.beforeClose && o.beforeClose.call(a)) ? this : (t.hasRouter && o.syncHistory && t.history.removeLast(o.syncHistory),
                        o.closeFirst ? (s.close((function() {
                            a.trigger("close"),
                            p(e)
                        }
                        )),
                    ...
                    ,
                    a.open = function(e) {
                        if (!1 === (o.beforeOpen && o.beforeOpen.call(a)))
                            return this;
                        if (o.iframe)
                            return s.open(e),
                            a;
            ...
            !t || "array" === e.typeof(t)) {
                ...
                if (o && void 0 !== i) {
                    ...
                    if (!0 === a)
                        ...
                        t;
                    if ("object" === e.typeof(i))
                        for (var l in i)
                            r[l] = i[l];
                    else
                        "object" !== e.typeof(i) && "string" == typeof a && (r[a] = i);
        ...
        e.array.delete = function(t, n, i) {
            ...
            function r(e) {
                for (var n = 0, r = 0; r < o.length; r++) {
                    ...
                    if (u === e || d === f)
                        return c ? t.splice(l, 1) : t.splice(r, 1),
                        a.push(r),
                        void ++n
                }
            }
        ...
        e.storage = function(n) {
              ...
              , s = {
                ...
                remove: function(t, n, i) {
                    if ("string" != typeof (t = o + t))
                        return void e.showLog("要删除的字段名只能是字符串", "bui.storage.remove");
                    var a = d(t) || [];
                    if ("number" == typeof n) {
            ...
            function d(t, n, i) {
                ...
                if ("number" == typeof n && i)
                    a = a && a[n] && a[n][i] || void 0;
                else if ("string" == typeof n) {
                    var s = e.array.index(a, n, i);
                    a = a && a[s]
                } else
                    a = "number" == typeof n ? a && a[n] || void 0 : a;
                return a
            }
            return u(n),
            s
    ...
    function(e, t) {
        ...
        e.date.format = function(e, t) {
            ...
            for (var a in /(y+)/.test(t) && (t = t.replace(RegExp.$1, (n.getFullYear() + "").substr(4 - RegExp.$1.length))),
            i)
                new RegExp("(" + a + ")").test(t) && (t = t.replace(RegExp.$1, 1 == RegExp.$1.length ? i[a] : ("00" + i[a]).substr(("" + i[a]).length)));
            return t
        }
        ,
        e.date.convert = function(e, t) {
            if (e && e.constructor == Date)
                return e;
            if ("number" == typeof e && 13 === String(e).length)
                return new Date(e);
            e = String(e);
            var n = new Date
              , i = n.getFullYear()
        ...
        e.animate = function(n) {
            ...
            var a, o, r, l, c = {
                ...
                property: function(e, t) {
                    var n = {};
                    "object" === _typeof(e) ? (n = e,
                    t = "") : "string" == typeof e && (n[e] = t || "");
                    return a.css(n),
                    this
                },
                open3D: function(e) {
                ...
                open3D: !1,
                animates: []
            }, n), u = [], d = [], f = "all 300ms ease-out";
            function p(n) {
                var i = t.extend(!0, s, n);
                if (i.id)
                    return (a = e.objId(i.id)).css({
                        "-webkit-transition": f,
                        transition: f
                    }),
                    o = i.open3D,
        ...
        e.mask = function(n) {
            var i = {
              ...
              , a = {
                ...
                show: function(t) {
                    if (h)
                        return;
                    (d = e.objId(l)) && d.length ? (d.css("display", "block"),
              ...
              , o = a.config = t.extend(!0, {}, i, e.config.mask, n)
              , r = e.guid()
              , l = o.id ? o.id.indexOf("#") > -1 ? o.id.substring(1) : o.id : r;
            t("body");
            var c, s, u = e.objId(o.appendTo), d = null, f = !1, p = !1, h = !1;
            function g(n) {
                h = !1;
            ...
            function m(n) {
                if (!h) {
                    ...
                    return (d = e.objId(l)) && d.length ? d.css("display", "block") : (u.append(c),
                    !p && u.css("position", "relative"),
                    d = e.objId(l)),
                    s = !0,
                    w.call(a, "show"),
        ...
        e.loading = function(n) {
            var i = {
                ...
                show: function(n) {
                    ...
                    if (d)
                        return;
                    var o = t.extend(!0, a, i);
                    (s = e.objId(o.id)) && s.length ? (y(o.text),
                    s[0].style.display = "-webkit-box",
                    m && m.show(),
                    o.callback && r.off("click.bui", "#" + l).on("click.bui", "#" + l, o.callback),
                    I.call(this, "show")) : b(o);
                    a.timeout && (p && clearTimeout(p),
                    p = setTimeout((function(e) {
                        x()
                    }
                    ), a.timeout));
                    return f = !0,
            ...
            t("body");
            var o, r = null, l = e.guid(), c = l + "-mask", s = e.objId(l), u = !1, d = !1, f = !1, p = null;
            a.id = l;
            var h = a.callback;
            ...
            function b(n) {
                if (!d) {
                    var o = t.extend(!0, {}, a, n);
                    if (s = e.objId(l),
                    s.children(".bui-loading-cell"),
                    s.hasClass("bui-loading-pause"))
                        s.removeClass("bui-loading-pause"),
                        I.call(this, "start");
                    else {
                        s.length && s.remove();
                    ...
                    return o.timeout && (p && clearTimeout(p),
            ...
            function y(t) {
                if (!d)
                    ...
                    void 0 === t ? o && o.text() : (o && o.html(t),
                    this)
            }
            function w() {
                if (!d)
                    return (s = e.objId(l)) && s.remove(),
                    s = null,
                    m && m.remove(),
                    u = !1,
                    f = !1,
            ...
            function x() {
                if (!d)
                    return s = e.objId(l),
                    (a.appendTo || s && s.length) && (s.css("display", "none"),
                    m && m.hide()),
                    f = !1,
                    I.call(this, "hide"),
                    this
    ...
    function(e, t) {
        e.slide = function(n) {
            var i, a, o, r, l, c, s, u, d, f, p, h, g, m, v, b, y, w, x, k, I, T, O, C, P, S = {
                ...
                load: function(e) {
                    var n = {
                      ...
                      , i = t.extend(!0, {}, n, e);
                    if (!1 === (i.beforeLoad && i.beforeLoad.call(S)))
                        return this;
                ...
                onMove: null,
                onEnd: null
            }, e.config.slide, n), L = {}, E = 0, N = !1, B = {}, D = null, R = [], A = [], M = !1, F = {
                x: {},
                y: {}
            };
            /hp-tablet/gi.test(navigator.appVersion);
            var U, H, _ = "", z = 0, $ = 0, V = !1, q = !1;
            L = {
                x1: 0,
                x2: 0,
                y1: 0,
            ...
            function W(n) {
                ...
                if (!1 === (s.onBeforeInit && s.onBeforeInit.call(S, s)))
                    return this;
                if (s.id) {
                    if (i = e.obj(s.id),
                    S.$el = i,
                    ...
                    "function" == typeof s.template)
                        i.html(s.template.call(S, s.data || []) || "");
                    ...
                    a = 0 == s.menu.indexOf("#") ? e.obj(s.menu) : i.find(s.menu).eq(0),
                    o = a.children(),
                    r = i.find(s.children).eq(0),
                    l = r.parent(),
                    c = r.children(),
                    C = c.length,
                    s.loop && c.length) {
                    ...
                    N || (!function() {
                        ...
                        var e = function(e) {
                            ...
                            if (e.currentIndex = i,
                            e.prevIndex = E,
                            !1 === (j.onBeforeTo && j.onBeforeTo.call(S, e)))
                                return !1;
                            ke.call(S, "beforeto", e),
                            n || o || (j.animate ? ie(i) : ie(i, "none"),
                            O && ae()),
                            e.stopPropagation()
                        };
            ...
            function Y(t) {
                ...
                c.addClass(j.alignClassName).height(v)),
                j.autoheight && i.addClass("bui-slide-autoheight"),
                j.autopage) {
                    var y = function(e, t) {
                        var n, i = "", a = (t = t || 1,
                        e);
                        for (i += '<div class="bui-slide-head bui-align-'.concat(j.alignPage, '">'),
                        i += "<ul >",
                        n = 1; n < Number(a) + 1; n++)
            ...
            function X(t) {
                ...
                L.y1 = n.clientY,
                L.direction = "",
                !1 === (j.onBeforeTouchstart && j.onBeforeTouchstart.call(S, t, L)))
                    return !1;
                j.stopHandle && e.unit.checkTargetInclude(t.target, j.stopHandle) ? V = !1 : (U = -E * T,
                H = -E * T,
                t.touches && t.touches.length > 1 || t.scale && 1 !== t.scale ? ee("x" == _ ? U : H) : (O && (oe(),
                O = !0),
                ke.call(S, "touchstart", t, L),
                j.onStart && j.onStart.call(S, t, L, S),
                V = !0,
                e.platform.isPC() && t.stopPropagation(),
                e.platform.isPC() && "IMG" === t.target.tagName && t.preventDefault()))
            }
            function Z(n) {
                if (V) {
                    var i = n.touches ? n.touches[0] : n;
                    if (n.touches && n.touches.length > 1 || n.scale && 1 !== n.scale)
                        ee("x" == _ ? U : H);
                    else {
                        if (q = !0,
                        L.x2 = i.clientX,
                        L.y2 = i.clientY,
                        L.direction || (L.direction = e.swipeDirection(L.x1, L.x2, L.y1, L.y2)),
                        !1 === (j.onBeforeTouchmove && j.onBeforeTouchmove.call(S, n, L)))
                            return !1;
                        "swipeleft" !== L.direction && "swiperight" !== L.direction || (n.preventDefault(),
                        n.stopPropagation()),
                        ...
                        try {
                            if (!e.platform.isPC() && "y" == _ && j.scroll) {
                                ...
                                if ("swipedown" === L.direction && o > 1)
                                    return void (q = !1);
                                if ("swipeup" === L.direction && r - o - l >= 2)
                                    return void (q = !1)
                            }
                        } catch (n) {}
                        m = L.x2 - L.x1,
                        ...
                        var c = J();
                        L.direction !== F[_].swipeDir && L.direction !== F[_].swipeDir2 || (j.delay && F[_].absDelta > j.distance && ee(F[_].move, "none"),
                        j.delay || ((j.bufferEffect || 0 == E && c > 1 && ("swipeleft" == L.direction || "swipeup" == L.direction) || E == c - 1 && c > 1 && ("swiperight" == L.direction || "swipedown" == L.direction) || E > 0 && E < c - 1 && c > 1) && ee(F[_].move, "none"),
                        n.preventDefault()),
                        j.onMove && j.onMove.call(S, n, L, S))
                    }
                }
            }
            function G(t) {
                switch (V = !1,
                ke.call(S, "touchend", t, L),
                L.direction) {
                case "swiperight":
                case "swipedown":
                    t.currentIndex = E - 1;
                ...
                if (t.prevIndex = E,
                !1 === (j.onBeforeTouchend && j.onBeforeTouchend.call(S, t, L)))
                    return !1;
                if (q) {
                    if (m = L.x2 - L.x1,
                    v = L.y2 - L.y1,
                    ...
                    F.y.delta = H,
                    F.y.absDelta = Math.abs(v),
                    "x" != j.direction || "swipeleft" != L.direction && "swiperight" != L.direction) {
                        if ("y" == j.direction && ("swipeup" == L.direction || "swipedown" == L.direction))
                            n = j.onBeforeTo && j.onBeforeTo.call(S, t)
                    } else
                        var n = j.onBeforeTo && j.onBeforeTo.call(S, t);
                    if (!1 === n)
                        return ee(F[_].delta),
                        ...
                        ne(),
                        !1;
                    F[_].absDelta > j.distance ? (Q.call(this, t, L, F),
                    j.onEnd && j.onEnd.call(S, t, L, S)) : F[_].absDelta < j.distance && ee(F[_].delta),
                    O && ae(),
                    "swipeleft" != L.direction && "swiperight" != L.direction || t.stopPropagation(),
                    z += L.y2 - L.y1,
                    $ += L.x2 - L.x1,
            ...
            function Q(e, t, i) {
                var a;
                if (se(),
                E = r.children(".active").index(),
                t.direction == i[_].swipeDir) {
                    var o = c.length
                      , l = o - j.visibleNum
                    ...
                    ke.call(S, "next", a)
                } else if (t.direction == i[_].swipeDir2)
                    if (E > 0) {
                        if (a = E - 1,
                        i[_].delta = -a * i[_].width,
                        ee(i[_].delta),
            ...
            function le(e) {
                ...
                if (!1 === (n.beforeLoad && n.beforeLoad.call(S)))
                    return this;
                var i = E - 1;
            ...
            function he(t) {
                var n = c.eq(t)
                  , i = o.eq(t).attr("href") || "";
                if (e.array.compare(R, t))
                    return ke.call(S, "to", t, "200"),
                    !1;
                j.autoload && (i ? (i = e.unit.resolvePath(i))in B ? (n.html(B[i]),
                R.push(t),
                !M && ke.call(S, "load", t, status),
                !M && ke.call(S, "to", t, status),
                M = !1) : (B[i] = "",
                D && D.show(),
                loader && loader.import(i, (function(e) {
                    B[i] = e,
                    n.html(e),
                    R.push(t),
    ...
    function(e, t) {
        ...
        function(a) {
            var o, r, l, c, s, u, d, f, p, h, g, m, v = {
                ...
                onInited: null,
                transition: 300
            }, e.config.swipe, a), y = {}, w = b.direction, x = b.hasChild, k = !1, I = !1, T = !1, O = !1, C = !1, P = !1, S = !1, j = !1, L = !1, E = b.handleMove, N = b.targetMove, B = !1, D = null, R = !1, A = !1;
            /hp-tablet/gi.test(navigator.appVersion);
            var M = !1
              , F = !1
              , U = !1
            ...
            function $(i) {
                ...
                if (a.onBeforeInit && a.onBeforeInit.call(v, a),
                R = !1,
                a.id)
                    return o = e.obj(a.id),
            ...
            function W() {
                "x" == w ? (I = !!p.length,
                T = !!f.length) : "y" == w ? (C = !!g.length,
                O = !!h.length) : "xy" == w && (C = !!g.length,
                O = !!h.length,
                T = !!f.length,
                I = !!p.length)
            }
            function K(n) {
                ...
                if (n.touches && n.touches.length > 1 || n.scale && 1 !== n.scale)
                    M = !1;
                else if (b.stopHandle && e.unit.checkTargetInclude(n.target, b.stopHandle))
                    M = !1;
                else {
                    if (y.id = b.id,
                    y.x1 = i.clientX,
                    y.y1 = i.clientY,
                    y.direction = "",
                    d = t(n.target).closest(b.handle),
                    !1 === (b.onBeforeTouchstart && b.onBeforeTouchstart.call(v, n, y)))
                        return !1;
                    ...
                    if (y.scrollObj = a.length ? a : o.length ? o : c.length ? c : s.length ? s : k,
                    y.scrollObj.scrollTop(),
                    x && !A && (l = (r = d).parent(),
                    f = l.children(b.swipeleft),
                    p = l.children(b.swiperight),
                    h = l.children(b.swipeup),
                    g = l.children(b.swipedown),
                    W(),
                    l.index(),
                    V(),
                    (0 == b.height || "" == l[0].style.height) && l.height(d[0] && d[0].offsetHeight)),
                    y.movingleft = parseInt(f.attr("data-moving") || m),
                    y.movingright = parseInt(p.attr("data-moving") || m),
                    y.movingup = parseInt(h.attr("data-moving") || m),
                    y.movingdown = parseInt(g.attr("data-moving") || m),
                    d.length) {
                        var P = !1;
                        switch (w) {
                        case "x":
            ...
            function Y(t) {
                if (M) {
                    ...
                    if (t.touches && t.touches.length > 1 || t.scale && 1 !== t.scale)
                        ...
                        if (y.x2 = a.clientX,
                        y.y2 = a.clientY,
                        !1 === (b.onBeforeTouchmove && b.onBeforeTouchmove.call(v, t, y)))
                            return !1;
                        ...
                        if (j) {
                            ...
                            if (m && s && t.preventDefault(),
                            m && !s)
                                return void (F = !1);
                            if (u && !l)
                                return void (F = !1)
                        }
                        if (C && !j && (u && l && t.preventDefault(),
                        m && s && t.preventDefault()),
                        !C && u && l && t.preventDefault(),
                        L) {
                            if (u && l && t.preventDefault(),
                            m && s)
                        ...
                        try {
                            if ("swipeup" === y.direction || "swipedown" === y.direction) {
                                ...
                                d[0].scrollTop,
                                d[0].scrollHeight,
                                y.scrollObj[0] && y.scrollObj[0].scrollTop || 0)
                        ...
                        !I || "swiperight" != y.direction || S || A || i ? !D || !C || "swipedown" != y.direction || j || A || i ? !T || "swipeleft" != y.direction || P || A || i ? !R || !O || "swipeup" != y.direction || L || A || i ? "swipeleft" == y.direction && S ? (c = y.movingright,
                        H = X(y, y.movingright),
                        N && ce(-y.deltax, 0, "none", i || p),
                        E && ce(-H, 0, "none", r),
                        pe.call(v, "movingleft", t, y),
                        F = !0,
                        t.stopPropagation()) : "swipeup" == y.direction && j ? (c = y.movingdown,
                        H = X(y, y.movingdown),
                        N && ce(0, -y.deltax, "none", i || g),
                        E && ce(0, -H, "none", r),
                        pe.call(v, "movingup", t, y),
                        F = !0,
                        t.preventDefault(),
                        t.stopPropagation()) : "swiperight" == y.direction && P ? (c = y.movingleft,
                        H = X(y, y.movingleft),
                        N && ce(y.deltax, 0, "none", i || f),
                        E && ce(H, 0, "none", r),
                        pe.call(v, "movingright", t, y),
                        F = !0,
                        t.stopPropagation()) : "swipedown" == y.direction && L && (c = y.movingup,
                        H = X(y, y.movingup),
                        N && ce(0, y.deltax, "none", i || h),
                        E && ce(0, H, "none", r),
                        pe.call(v, "movingdown", t, y),
                        F = !0,
                        t.preventDefault(),
                        t.stopPropagation()) : (c = y.movingup,
                        H = Z(y, y.movingup),
                        N && ce(0, H, "none", h),
                        E && ce(0, -y.deltax, "none", r),
                        pe.call(v, "movingup", t, y),
                        F = !0,
                        t.preventDefault(),
                        t.stopPropagation()) : (c = y.movingleft,
                        H = Z(y, y.movingleft),
                        N && ce(H, 0, "none", f),
                        E && ce(-y.deltax, 0, "none", r),
                        pe.call(v, "movingleft", t, y),
                        F = !0,
                        t.stopPropagation()) : (c = y.movingdown,
                        H = X(y, y.movingdown),
                        N && ce(0, H, "none", g),
                        E && ce(0, y.deltax, "none", r),
                        pe.call(v, "movingdown", t, y),
                        F = !0,
                        t.preventDefault(),
                        t.stopPropagation()) : (c = y.movingright,
                        H = X(y, y.movingright),
                        N && ce(H, 0, "none", p),
                        E && ce(y.deltax, 0, "none", r),
                        pe.call(v, "movingright", t, y),
            ...
            function J(t) {
                if (M = !1,
                U = !0,
                pe.call(v, "touchend", t, y),
                !1 === (b.onBeforeTouchend && b.onBeforeTouchend.call(v, t, y)))
                    return !1;
                if (F) {
                    var n = ""
                      , i = !1
                    ...
                    if (I && a && l > b.distance && !S && !A)
                        Q(),
                        pe.call(v, y.direction, t, y),
                        pe.call(v, "open", y.direction);
                    else if (T && i && l > b.distance && !P && !A)
                        G(),
                        pe.call(v, y.direction, t, y),
                        pe.call(v, "open", y.direction);
                    else if (O && o && l > b.distance && !L && !A)
                        ee(),
                        pe.call(v, y.direction, t, y),
                        pe.call(v, "open", y.direction);
                    else if (C && r && l > b.distance && !j && !A)
                        te(),
                        pe.call(v, y.direction, t, y),
                        pe.call(v, "open", y.direction);
                        ...
                        !A && l < b.distance && (i && T && !P && ie(),
                        a && I && !S && ne(),
                        o && O && !L && ae(),
                        r && C && !j && oe(),
                        b.alwaysTrigger && pe.call(v, "close", n),
                        pe.call(v, y.direction, t, y));
                    H = y.direction,
                    M = !1,
                    !e.platform.isPC() && (F = !1),
            ...
            function G(e) {
                (e = e || {}).transition = e.transition || b.transition,
                e.target = e.target || f,
                e.handle = e.handle || r,
                n && n.close(),
                A = !0,
            ...
            function ne(e) {
                ...
                i = null,
                D = null,
                z.removeEventListener("click", le, !0)),
            ...
            function ce(e, t, n, i) {
                var a = i || o
                  , r = (e = e || 0,
                t = t || 0,
                b.zoom ? parseFloat(e) / 100 + "rem" : parseFloat(e) + "px")
            ...
            function de() {
                if (!R) {
                    ...
                    return o.on(t.touchstart, K).on(t.touchmove, Y).on(t.touchend, J).on(t.touchcancel, (function(t) {
                        b.autoClose && e.platform.isPC() && (U || F) && (ne(),
                        ie(),
                        oe(),
                        ae(),
                        pe.call(v, "close", H),
    ...
    function(e, t) {
        e.sidebar = function(n) {
            var i, a = {
                ...
                onInited: null,
                distance: 40
            }, e.config.sidebar, n), r = null, l = null, c = !1, s = !1, u = null;
            function d(n) {
        ...
        e.btn = function(n) {
            var i, a, o, r, l = {}, c = {
                load: function(n) {
                    ...
                    i.off("click.bui", r).on("click.bui", r, (function(i) {
                        ...
                        if (d && !m && !(d && d.indexOf("javascript:") > -1)) {
                            var v = r.attr("param") || ""
                              , b = v && v.indexOf("{") > -1 && v.indexOf("}") > -1 ? JSON.parse(r.attr("param")) : {};
                            (r.attr("progress") ? "false" != r.attr("progress") : a) && e.loading({
                                autoTrigger: !0,
                                display: "block",
                                opacity: 0,
                                timeout: l.timeout
                ...
                submit: function(n, a) {
                    ...
                    function c(i) {
                        if (!1 === (l.beforeCallback && l.beforeCallback.call(this, i)))
                            return i.preventDefault(),
                            i.stopPropagation(),
                            !1;
                        var r = this
                        ...
                        if (!t(this).hasClass("disabled") && "true" != t(this).attr("disabled")) {
                            var s = "none" == c ? "#fff" : c;
                            if (a.appendTo = r,
                            a.background = a.background || s,
                            a.display = a.display || "inline",
                            a.width = a.width || 15,
                            a.height = a.height || 15,
                            a.text = a.text || "加载中",
                            a.autoClose = 1 == a.autoClose,
                            a.autoTrigger = 0 != a.autoTrigger,
                            o) {
                                if (o.isLoading())
                                    return;
                                o.show()
            ...
            return function(n) {
                n && "object" === e.typeof(n) ? (l.id = n.id || "",
                l.handle = n.handle || "",
                l.progress = "progress"in n && n.progress,
                l.replace = "replace"in n && n.replace,
                l.timeout = n.timeout || 3e3,
                l.beforeCallback = n.beforeCallback || null,
                i = t(l.id)) : "string" == typeof n && (l.id = n || "",
                l.handle = "",
                l.progress = !1,
                l.replace = !1,
                l.timeout = 3e3,
                l.beforeCallback = null,
                i = e.obj(l.id));
                r = l.handle,
                a = l.progress,
                o = l.replace
    ...
    function(e, t) {
        e.dialog = function(n) {
            var i, a, o, r, l = {
                ...
                open: function(n) {
                    ...
                    var o = {
                      ...
                      , l = o;
                    "function" == typeof n ? l.callback = n : "string" == typeof n ? l.effect = n : n && "object" === e.typeof(n) && (l = t.extend(!0, {}, o, n));
                ...
                config: s,
                init: I
            }, s = c.config = t.extend(!1, {}, l, e.config.dialog, n), u = "", d = "", f = "", p = "fadeInDown", h = !1, g = !1, m = !1, v = !1, b = "" !== s.needRemove ? s.needRemove : !!s.render, y = {}, w = window && window.viewport && window.viewport.width() || document.documentElement.clientWidth, x = window && window.viewport && window.viewport.height() || document.documentElement.clientHeight, k = !1;
            function I(n) {
                var l = t.extend(!0, s, n);
                switch (l.onBeforeInit && l.onBeforeInit.call(c, l),
                l.appendTo = l.appendTo || e.hasRouter && router.currentPage() || "body",
                k = !1,
                o = l.effect,
                b = "" !== l.needRemove ? l.needRemove : !!l.render,
                ...
                l.fullscreen && (u = "bui-dialog-fullscreen",
                o = l.effect || p),
                ...
                i = e.objId(l.id)) : ((i = e.obj(l.id)).addClass(u).css("z-index", l.zIndex),
                l.useBox && i.addClass("bui-box-vertical")),
                ...
                try {
                    ...
                    n.mask && !r && (r = e.mask({
                        ...
                        callback: function(e) {
                            if (!1 === (n.onMask && n.onMask.call(c, e)))
                                return !1;
                            s.autoClose && (b ? O(P) : O())
                        }
                    }))
            ...
            function T(t) {
                ...
                n += "\t</div>",
                t.buttons && t.buttons.length && (n += '\t<div class="bui-dialog-foot"><div class="bui-box">',
                t.buttons.forEach((function(e, t) {
            ...
            function O(t) {
                if (m && !k && !g) {
                    var n = {};
                    "function" == typeof t ? n.callback = t : "string" == typeof t ? (n.effect = t,
                    n.callback = s.onClose) : t && "object" === e.typeof(t) && (n = t),
            ...
            function C(e, t) {
                if (y[e]instanceof Array)
                    for (var n = y[e], i = 0, a = n.length; i < a; i++)
                        n[i](t)
            }
            function P() {
                try {
            ...
            function S() {
                ...
                i.on("click.bui", ".bui-dialog-foot .bui-btn", (function(e) {
                    if (e.target = this,
                    !1 === (s.callback && s.callback.call(c, e, c)))
                        return !1;
                    s.autoClose && (b ? O(P) : O()),
                    e.stopPropagation()
                }
    ...
    function(e, t) {
        e.confirm = function(n, i) {
            ...
            ;
            var r = {};
            return "object" === _typeof(n) ? (n.content = '<div class="bui-dialog-text bui-box-center" style="height:100%;">' + n.content + "</div>",
            r = t.extend(o, e.config.confirm, n)) : ((r = t.extend(o, e.config.confirm)).content = '<div class="bui-dialog-text bui-box-center" style="height:100%;">' + n + "</div>",
        ...
        !function(t, n) {
            t.prompt = function(i, a) {
                ...
                var l = {}
                  , c = ""
                  , s = "";
                switch ("object" === _typeof(i) ? c = (l = n.extend(r, t.config.prompt, i)).content || "" : ((l = n.extend(r, t.config.prompt)).callback = a || function() {}
                ,
                c = i || ""),
                l.type) {
                case "number":
                ...
                o.value = function(e) {
                    return void 0 === e ? s : (n("#" + o.config.id).find(".bui-prompt-text").val(e),
                    s = e)
                }
                ,
                o.focus = function(e) {
    ...
    function(e, t) {
        e.hint = function(n, i) {
            ...
            var o, r, l = {
                ...
                onClose: null,
                onHided: null
            }, e.config.hint, n), s = 0, u = null, d = null, f = "", p = !1, h = !1;
            function g(n) {
                ...
                c = l.config = i,
                function(n, i, a, o) {
                    var r, l = "12" + a, s = o ? e.obj(o) : t("body");
                    switch (c.position) {
                    case "top":
                        r = "bui-hint-top";
                        break;
    ...
    function(e, t) {
        e.pullrefresh = function(n) {
            var i, a, o, r, l, c, s, u = "." + e.prefix("scroll-head"), d = "." + e.prefix("scroll-main"), f = "." + e.prefix("scroll-foot"), p = {
                id: "",
                uid: "",
                stopHandle: "",
                childrenTop: u,
                ...
                config: g,
                init: j
            }, g = h.config = t.extend(!0, {}, p, e.config.pullrefresh, n), m = !1, v = (new Date).getTime(), b = 0, y = !1, w = !1, x = !1, k = null;
            /hp-tablet/gi.test(navigator.appVersion);
            var I = null
              , T = 0
              , O = 0
            ...
            function j(n) {
                ...
                if (l.onBeforeInit && l.onBeforeInit.call(h, l),
                l.id)
                    return i = e.obj(l.id),
                    g = h.config = l,
                    i[0],
            ...
            function N(n) {
                ...
                S.direction = "",
                E = i.scrollTop(),
                g.stopHandle && e.unit.checkTargetInclude(n.target, g.stopHandle))
                    C = !1;
                else if (n.touches && n.touches > 1 || n.scale && 1 !== n.scale)
                    C = !1;
                else {
                    var r, l, s;
                    if (!1 === (g.onBeforeTouchstart && g.onBeforeTouchstart.call(h, n, S)))
                        return !1;
                    c = g.lastUpdated ? (r = (new Date).getTime() - v,
                    l = Math.floor(r / 36e5),
                    s = Math.floor(r / 6e4),
                    l <= 0 && s <= 0 ? "刚刚更新" : l <= 0 && s > 0 ? s + "分钟前更新" : "上次更新时间:" + (l < 10 ? "0" + l : l) + ":" + (s < 10 ? "0" + s : s)) : g.refreshTips.end,
                    $.call(h, "touchstart", n, S),
                    "head" === g.handleMove && a.css("zIndex", 10),
                    t(window).scrollTop() <= 0 && E <= 0 && g.onRefresh && !y ? (C = !0,
                    t(this).css("touch-action", "none")) : (C = !1,
                    a.css("zIndex", 0)),
            ...
            function R(t) {
                ...
                if (C)
                    if (t.touches && t.touches.length > 1 || t.scale && 1 !== t.scale)
                        ...
                        if (S.x2 = n.clientX,
                        S.y2 = n.clientY,
                        !1 === (g.onBeforeTouchmove && g.onBeforeTouchmove.call(h, t, S)))
                            return !1;
                        ...
                        "swipedown" == S.direction ? ($.call(h, "movingdown", t, S),
                        U((l = Math.abs(S.y2 - S.y1)) / 2, !1),
                        l >= g.distance ? B || (k.show({
                        ...
                        D = !0),
                        P = !0,
                        g.maxDistance > g.distance && l >= g.maxDistance && (k.show({
                            text: g.refreshTips.start,
                            onlyText: !1
                        }),
                        y = !0,
                        ...
                        P = !1),
                        t.preventDefault(),
                        t.stopPropagation()) : "swipeup" == S.direction && ($.call(h, "movingup", t, S),
                        P = !0,
                        t.stopPropagation()),
                        k && k.pause()
                    }
            ...
            function A(e) {
                ...
                !1 !== (g.onBeforeTouchend && g.onBeforeTouchend.call(h, e, S)) && (t(this).css("touch-action", "auto"),
                P ? ("swipedown" == S.direction ? ($.call(h, S.direction, e, S),
                l >= g.distance ? (U(g.distance / 2),
                k.show({
                    text: g.refreshTips.start,
                    onlyText: !1
                }).start(),
                ...
                B = !1,
                D = !1,
                S = {}) : "swipeup" == S.direction && ($.call(h, S.direction, e, S),
                e.stopPropagation()),
                T += S.y2 - S.y1,
                O += S.x2 - S.x1,
                S.lastX = O,
    ...
    function(e, t) {
        e.scroll = function(n) {
            var i, a, o, r, l, c, s, u, d, f = "." + e.prefix("list"), p = "." + e.prefix("scroll-head"), h = "." + e.prefix("scroll-main"), g = "." + e.prefix("scroll-foot"), m = {
                id: "",
                uid: "",
                childrenTop: p,
                childrenMain: h,
                ...
                to: A,
                toBottom: function(e) {
                    i[0] && (i[0].scrollTop = i[0].scrollHeight,
                    e && e.call(v));
                    return this
                },
                ...
                config: b,
                init: E
            }, b = v.config = t.extend(!0, {}, m, e.config.scroll, n), y = b.page, w = 0, x = null, k = !1, I = !0, T = !0, O = !1, C = !1, P = b.page, S = b.pageSize, j = !1, L = {};
            function E(n) {
                var o = t.extend(!0, b, n);
                if (o.onBeforeInit && o.onBeforeInit.call(v, o),
                t(window),
                o.id) {
                    i = e.obj(o.id),
                    P = o.page,
            ...
            function N(e) {
                var t = e.target
                  , n = t.scrollTop || 0
                  , i = t.scrollLeft || 0;
                "y" === b.direction ? 0 == n ? U.call(v, "scrolltop", e) : t.scrollTop + t.clientHeight >= (t && t.scrollHeight - b.endDistance) && b.onLoad && (b.page = v.config.page = ++P,
                b.autoScroll && s && s.call(v, b.page, S),
                U.call(v, "scrollbottom", e)) : 0 == i ? U.call(v, "scrolltop", e) : t.scrollLeft + t.clientWidth >= (t && t.scrollWidth - b.endDistance) && b.onLoad && (b.page = v.config.page = ++P,
                b.autoScroll && s && s.call(v, b.page, S),
                U.call(v, "scrollbottom", e)),
                U.call(v, "scrollend", e),
                b.onScrolling && b.onScrolling.call(v, e, v)
            }
            function B(e, t) {
                return C = !1,
                T && !O && (b.page = v.config.page = e,
                b.onBeforeLoad && b.onBeforeLoad.call(v, e, t),
                b.onLoad && x && x.start({
            ...
            function A(e, t) {
                ...
                var n = i.height()
                  ...
                  , l = a.scrollHeight
                  , c = r * parseInt(e) - r;
                return l > n && (a.scrollTop = c,
                U.call(v, "to", e),
                t && t.call(v, parseInt(e))),
                this
            }
            function M(t) {
                e.$(".bui-page");
    ...
    function(e, t) {
        e.list = function(n) {
            var i, a, o = {
                ...
                modify: function(e) {
                    return r = o.config = t.extend(!0, {}, o.config, e),
                    p = r.data,
                    this
                },
                destroy: function(e) {
                ...
                option: function(n, i) {
                    return "data" == n && void 0 !== i ? function(n, i) {
                        var a;
                        if ("string" == typeof i)
                            try {
                                a = JSON.parse(i)
                ...
                onFail: null,
                callback: null
            }, e.config.list, n), l = r.url, c = [], s = r.page;
            r.page;
            var u, d, f, p = {}, h = !1, g = r.data;
            function m(n) {
            ...
            function b(i, l, s) {
                var h = this
                  , m = s || r.commandLoad;
                if (p = t.extend(!0, {}, g, r.data, p),
                r.field.page.length && e.unit.setKeyValue(r.field.page, i, p),
                r.field.size.length && e.unit.setKeyValue(r.field.size, l, p),
                r.page = o.config.page = i,
                r.data = p,
                !r.localData)
                    return r.urlrule && (r.url = v(r)),
                    r.success = b,
                ...
                function b(t, l, s) {
                    ...
                    var v, b, y, w;
                    if ("string" == typeof (p = r && r.field && "" == r.field.data ? u || [] : "object" === e.typeof(u) && e.unit.getKeyValue(r.field.data, u) || []) && /\[?.+\]$/g.test(p))
                        try {
                            g = JSON.parse(p)
                        } catch (t) {
                            g = p,
                    ...
                    r.localData && (v = i,
                    b = r.pageSize,
                    p = (w = (v - 1) * b) + b >= (y = p).length ? y.slice(w, y.length) : y.slice(w, w + b));
                    ...
                    try {
                        I ? (r.onRefresh && r.onRefresh.call(o, f, u, s),
                        k.call(h, "refresh", t, i, s),
                        r.refresh && f.reverse()) : (k.call(this, "onloadbefore"),
                        r.onLoad && r.onLoad.call(o, f, u, s),
                        k.call(h, "onload", t, i, s)),
        ...
        e.searchbar = function(n) {
            var i, a, o, r, l = {
                ...
                search: function(e) {
                    var t = e || a;
                    return a = t,
                    p.call(this, "search", {}, t),
                    s.callback && s.callback.call(this, {}, t),
                    this
                },
                reset: function() {
                    return o.val(""),
                ...
                config: s,
                init: d
            }, s = c.config = t.extend(!0, {}, l, e.config.searchbar, n), u = !1;
            function d(n) {
                var l = t.extend(!0, s, n);
                ...
                s = c.config = l,
                o = i.find("input"),
                (r = i.find(l.handleRemove)).length < 1 && (o.after('<i class="' + l.handleRemove.substr(1) + '"></i>'),
                r = i.find(l.handleRemove)),
                r.hide(),
                u || function(e) {
    ...
    function(e, t) {
        e.select = function(n) {
            var i, a, o, r, l, c, s = {
                ...
                disabledSelect: function(e) {
                    if (void 0 === e)
                        ...
                        if ("number" != typeof e)
                            return void console.log("index 必须为数字");
                ...
                unselect: function() {
                    if ("checkbox" == u.type) {
                        ...
                        u.data && u.data.forEach((function(n, i) {
                            ...
                            e.array.index(t, n[h]) > -1 ? a.prop("checked", null) : (a.prop("checked", !0),
                            y.push(n[h]),
                            w.push(n[g]))
                        }
                        )),
                ...
                unselected: function(t) {
                    ...
                    return n.forEach((function(t, n) {
                        u.data.forEach((function(n, i) {
                            var a = n[h] || n
                              , o = n[g] || n;
                            t != o && t != a || (l.eq(i).find("input").prop("checked", null),
                            e.array.remove(y, a),
                            e.array.remove(w, o))
                        }
                        ))
                ...
                callback: null
            }, e.config.select, n), d = e.guid(), f = u.name || e.guid(), p = !0, h = u.field.name, g = u.field.value, m = u.field.image, v = u.field.icon, b = null, y = [], w = [], x = [], k = [], I = "", T = !1;
            function O(n) {
                var f = t.extend(!0, u, n);
                if (f.onBeforeInit && f.onBeforeInit.call(s, f),
                f.appendTo = f.appendTo || e.hasRouter && router.currentPage() || "body",
                y = [],
                w = [],
                x = [],
                k = [],
                u = s.config = f,
                b = "function" == typeof f.template ? f.template : j,
                f.data && f.data.length || T)
                    var h = b.call(this, f.data);
                if (s.template = b,
                !f.popup) {
                    if (!f.id)
                        return void e.hint("select id 必须有");
                    a = e.obj(f.id),
                    (f.data && f.data.length || T) && a.html(h)
                }
                if (f.popup)
                    if (d = f.id && f.id !== f.trigger && e.obj(f.id).attr("id") || d,
                    a = e.obj(d),
                    c)
                        a.find(".bui-dialog-list").html(h);
                    else {
                        var g = function(n) {
                            var i = ""
                            ...
                            u.popup && (i += '<div id="' + d + '" class="bui-dialog bui-dialog-select">',
                            (u.title || u.needSearch) && (i += '<div class="bui-dialog-head">\n                                '.concat(u.title || u.templateTitle ? r : "", "\n                                ").concat(u.needSearch ? a : "", "\n                            </div>")),
                            i += '  <div class="bui-dialog-main">');
                            u.popup && (i += '<div class="bui-dialog-list"></div>',
                            i += "  </div>",
                            u.buttons.length > 0 && (i += '    <div class="bui-dialog-foot bui-box">',
                            t.each(u.buttons, (function(e, t) {
                                i += '        <div class="span1">',
                        ...
                        f.appendTo && f.id && f.data && !f.data.length && (t(f.appendTo).append(a.prop("outerHTML")),
                        a.remove(),
                        a = t(f.appendTo).find(f.id))
                    }
                return s.$el = a,
                l = a.find(f.handle),
                ...
                function(n) {
                    ...
                    n.trigger && n.popup && (o = n.placeholder || t.trim(r.html() || ""),
                    n.placeholder && r.html(n.placeholder),
                    i.off("click.bui").on("click.bui", (function(e) {
                    ...
                    function l(e) {
                        ...
                        h.css("display", "block")) : (g.css("display", "none"),
                        h.css("display", "none"))
                    }
                    var c = function(i) {
                        ...
                        if (!o) {
                            ...
                            i.target = a[0],
                            i.index = u,
                            (d && "INPUT" !== r || !d && "INPUT" === r) && (n.toggle || "checkbox" == n.type) ? (e.array.remove(y, c),
                            e.array.remove(w, l),
                            e.array.remove(x, u),
                            e.array.remove(k, u),
                            M.call(s, "uncheck", i)) : (P({
                                name: c,
                                value: l,
                                index: u
                            }),
                    ...
                    a.off("clilck.bui", ".bui-dialog-result .bui-btn").on("click.bui", ".bui-dialog-result .bui-btn", (function(i) {
                        var a = t(i.currentTarget).find("input")
                          ...
                          , l = a.attr("text")
                          , c = a.attr("value")
                          , u = e.array.index(n.data, c, "value");
                        (r && "INPUT" !== o || !r && "INPUT" === o) && (n.toggle || "checkbox" == n.type) ? (a.prop("checked", !1),
                        M.call(s, "uncheck", i),
                        e.array.remove(y, l),
                        e.array.remove(w, c),
                        e.array.remove(x, u),
                        e.array.remove(k, u)) : (a.prop("checked", !0),
                        M.call(s, "check", i),
                        P({
                            name: l,
                            value: c,
            ...
            function j(n, i) {
                ...
                return t.each(n, (function(n, i) {
                    ...
                    var f = function(t) {
                        ...
                        for (var i in t)
                            "string" != typeof t[i] && "number" != typeof t[i] || n.setAttribute(i, t[i]);
                        switch (u.type) {
                        case "mulelect":
                        ...
                        n
                    }(t.extend(!0, {}, i, d)).outerHTML;
                    if (r += '    <div class="bui-btn bui-box bui-btn-line">',
                    "left" == u.direction && (r += f),
                    l) {
                    ...
                    "center" == u.direction ? (r += '        <div class="span1" align="center">' + o + "</div>",
                    r += f) : r += '        <div class="span1">' + o + "</div>",
            ...
            function L(e) {
                ...
                u.popup && c ? (!c.isOpen() && c.open(t),
                M.call(s, "show")) : (a.css("display", "block"),
                t.callback ? t.callback() : M.call(s, "show")),
                this
            }
            function E(e) {
                ...
                : "string" == typeof e ? t.effect = e : "object" === _typeof(e) && (t = e),
                u.popup && c ? (c.isOpen() && c.close(t.effect || t.callback),
                M.call(s, "hide")) : (a.css("display", "none"),
                t.callback ? t.callback() : M.call(s, "hide")),
                this
            }
            function N(t, n) {
                if (void 0 === t)
                ...
                (u.data.length < 1 || u.data.length !== l.length) && (u.data = [],
                console.log(),
                C()),
                u.data && u.data.forEach((function(t, n) {
                    var i = t && "object" === e.typeof(t) && t.hasOwnProperty(h) ? String(t[h]) : String(t)
                      ...
                      , r = l.eq(n).find("input");
                    if ("" == t)
                        return r.prop("checked", !1),
                        y = [],
                        w = [],
                        x = [],
                        void (k = []);
                    var s = e.array.index(T, i);
                    e.array.index(T, o) > -1 || s > -1 ? ("radio" != u.type && "select" != u.type || (d = [],
                    f = [],
                    b = [],
                    m = []),
                    d.push(i),
                    ...
                    b.push(n),
                    c[n] = r,
                    r.prop("checked", !0)) : r.prop("checked", !1)
                }
                )),
                y = d.slice(0),
                w = f.slice(0),
                ...
                i && u.change && (i.attr("value", f.join(",")),
                r.text(y.join(",") || I)),
                a.attr("value", f.join(",")),
                p = !1
            }
            function B(e) {
                return void 0 === e ? y.join(",") : (i && u.change && (i.attr("text", e),
                r.html(e || o)),
                a.attr("text", e),
                this)
            }
            function D(e) {
                ...
                "checkbox" == u.type || "mulselect" == u.type ? (B(y.join(",")),
                N(w.join(","))) : (B(y[0]),
                N(w[0])),
                this
            }
    ...
    function(e, t) {
        e.dropdown = function(n) {
            var i, a, o, r, l, c, s = {
                ...
                callback: null,
                onChange: null
            }, e.config.dropdown, n), d = document.documentElement.clientWidth, f = !1, p = "", h = "", g = "";
            function m(n) {
                var h = t.extend(!0, u, n);
                if (h.onBeforeInit && h.onBeforeInit.call(s, h),
                h.id) {
                    if (i = e.obj(h.id),
                    s.$el = i,
                    u = s.config = h,
                    a = i.children(h.handle),
                    c = h.target ? i.find(h.target) : a.next(),
                    h.placeholder && y(h.placeholder),
                    p = h.placeholder || a.text(),
                    ...
                    if (l = h.width > 0 ? h.width : r ? d : h.width,
                    parseFloat(l) > 0 && c.width(l),
                    function(e, t) {
                        c.addClass(e),
                        r && c.css({
                            left: t
                        })
                    }(h.showArrow ? T[o].arrowPosition + " " + T[o].menuPosition : T[o].menuPosition, T[o].left),
                    h.value)
                        v(h.value);
                    else {
                    ...
                    return f || function(e) {
                        var n = function(n) {
                            if (!t(this).hasClass("disabled")) {
                                ...
                                a.css("display", "none"),
                                I.call(s, "hide")) : (t(this).addClass("active"),
                                a.css("display", "block"),
                                I.call(s, "show")),
                                n.stopPropagation()
                            }
            ...
            function v(n) {
                if (void 0 === n)
                    return event && event.target ? t(event.target).attr("value") : a.attr("value");
                ...
                u.data && u.data.length) {
                    ...
                    d > -1 ? (l.eq(d).addClass("active"),
                    r.attr("value", n),
                    u.change && y.call(this, u.data[d].name),
                    h = n) : f > -1 && (l.eq(f).addClass("active"),
                    r.attr("value", u.data[f].value),
                    u.change && y.call(this, n),
                    h = u.data[f].value)
                } else
                    l.each((function(e, i) {
                        var a = i.innerText
                          , o = i.getAttribute("value");
                        a != n && o != n || (t(this).addClass("active"),
                        r.attr("value", o),
                        u.change && y.call(this, a),
                        h = o)
                    }
                    ));
            ...
            function b(e) {
                ...
                n.length >= 0 && (v(n.attr("value") || t.trim(n.text()) || ""),
                u.showActive && n.addClass("active").siblings().removeClass("active"));
                return this
            }
            function y(n) {
                if (void 0 === n)
                    return g || t.trim(a.text());
    ...
    function(e, t) {
        e.accordion = function(n) {
            var i, a, o = {
                ...
                onInited: null,
                callback: null
            }, e.config.accordion, n), l = null, c = !1;
            function s(n) {
                ...
                c || function(e) {
                    var n = function(n) {
                        if (!t(this).hasClass("disabled") && !t(this).attr("href")) {
                            if (!1 === (e.callback && e.callback.call(o, n)))
                                return !1;
                            u.call(this, n, e),
            ...
            function u(n, a) {
                ...
                a.single ? l ? (r.removeClass("active"),
                c.css("display", "none"),
                g.call(o, "hide", n)) : (f(),
                r.addClass("active"),
                c.css("display", "block"),
                g.call(o, "show", n)) : l ? (r.removeClass("active"),
                c.css("display", "none"),
                g.call(o, "hide", n)) : (r.addClass("active"),
                c.css("display", "block"),
                g.call(o, "show", n))
            }
            function d(e, n) {
                e = e || 0;
                (n ? t(n) : l).children(r.handle).eq(e).addClass("active").next(r.target).css("display", "block")
            }
            function f() {
                return (i = p()).each((function(e, n) {
    ...
    function(e, t) {
        e.rating = function(n) {
            var i, a, o, r, l, c = {
                ...
                off: m,
                disabled: function(e) {
                    (e = 0 != e) ? (i.off("click.bui", s.handle),
                    v.call(c, "disabled")) : g();
                    return this
                },
                enabled: g,
                show: function(e) {
                    var t = function(e) {
                        var t, n = "", i = (e = String(e) || String(r),
                        0), a = s.stars, o = [];
                        o = e.indexOf(".") > -1 ? e.split(".") : [e, 0];
                        var l = parseInt(o[0]);
                        for (t = o[1] / 10 * 100 + "%",
                        i = 0; i < a; i++)
                            i < l && (n += '<div class="bui-rating-cell" ><div class="bui-rating-cell-full" style="width:100%;">&nbsp;</div></div>'),
                ...
                onInited: null,
                callback: null
            }, e.config.rating, n), u = !1;
            function d(n) {
                var r = t.extend(!0, s, n);
                if (r.onBeforeInit && r.onBeforeInit.call(c, r),
                r.id)
                    return i = e.obj(r.id),
                    c.$el = i,
                    s = c.config = r,
            ...
            function p(e) {
                ...
                l.each((function(e, i) {
                    var r = parseInt(n[0]);
                    1 == n.length && e < r ? t(i).addClass(a) : 2 == n.length && (e < r && t(i).addClass(a),
                    e == r && t(i).addClass(o))
                }
                ))
            }
            function h(e) {
                return void 0 !== e && /^-?\d+(\.\d+)?$/.test(e) ? (i.attr("value", e),
                p(e),
                r = e,
                v.call(c, "change", e)) : r = i.attr("value"),
                r
            }
            function g(e) {
                return s.disabled = !1,
    ...
    function(e, t) {
        e.actionsheet = function(n) {
            var i, a, o, r = {
                ...
                option: function(t, n) {
                    return "buttons" == t && void 0 !== n ? function(t, n) {
                        if (n && "array" === e.typeof(n)) {
                            var i = u(n);
                ...
                onInited: null,
                callback: null
            }, e.config.actionsheet, n), c = !1;
            function s(n) {
                var s, p, g = t.extend(!0, l, n);
                if (g.onBeforeInit && g.onBeforeInit.call(r, g),
                a = e.obj(g.trigger),
                l = r.config = g,
                c)
                    e.obj(l.id).find(".bui-list").html(u(g.data || g.buttons));
                else {
                    var m = "function" == typeof g.template ? g.template.call(r, g.data || g.buttons) : function(e) {
                        var t = parseFloat(l.width)
                          ...
                          , i = "";
                        e && e.length && (i += '<div id="' + l.id + '" class="bui-actionsheet" style="' + n + '">',
                        i += '    <ul class="bui-list">',
                        i += u(e),
                        i += "    </ul>",
                        l.cancelText && (i += '    <div class="bui-btn" value="cancel">' + l.cancelText + "</div>"),
                        i += "</div>");
                        return i
                    }(g.data || g.buttons);
                ...
                ,
                o && o.off("click.bui", l.handle).on("click.bui", l.handle, s),
                a && a.off("click.bui").on("click.bui", p),
                c = !0),
    ...
    function(e, t) {
        e.number = function(n) {
            var i, a, o, r = {
                ...
                disabled: function(n) {
                    g();
                    var i = this && "htmldivelement" === e.typeof(this) ? t(this) : a;
                    (n = 0 != n) ? i.attr("disabled", "disabled") : i.removeAttr("disabled");
                    return this
                },
                reset: function() {
                    var e = l.value || l.min;
                ...
                values: function(t) {
                    ...
                    if (t && "array" === e.typeof(t))
                        return Array.prototype.slice.call(o).forEach((function(e, n) {
                ...
                onChange: null,
                callback: null
            }, e.config.number, n), c = !1, s = !1, u = null;
            function d(n) {
                ...
                i = d.step,
                u = e.obj(d.parentId),
                "object" === _typeof(d.id) ? (o = e.obj(d.id),
                s = !1) : "string" == typeof d.id && 0 === d.id.indexOf("#") ? (o = e.obj(d.id),
                s = !0) : (o = u.find(d.id),
                s = !1),
                l = r.config = d,
                d.render && function(t) {
                ...
                c || function(n) {
                    ...
                    s ? (n.onInput && o.off("input", n.input).on("input", n.input, e.unit.debounce(p, 400)),
                    o.off("change", n.input).on("change", n.input, g),
                    o.off("click.bui", n.prev).on("click.bui", n.prev, b),
                    o.off("click.bui", n.next).on("click.bui", n.next, y)) : (n.onInput && u.off("input", i).on("input", i, e.unit.debounce(p, 400)),
                    u.off("change", i).on("change", i, g),
                    u.off("click.bui", a).on("click.bui", a, b),
                    u.off("click.bui", d).on("click.bui", d, y));
                    c = !0
                }(d),
            ...
            function g() {
                "object" === _typeof(l.id) ? (o = e.obj(l.id),
                s = !1) : "string" == typeof l.id && 0 === l.id.indexOf("#") ? (o = e.obj(l.id),
                s = !0) : (o = u.find(l.id),
                s = !1),
                o.children(l.prev),
                o.children(l.next),
    ...
    function(e, t) {
        e.stepbar = function(n) {
            var i, a, o = {
                ...
                onChange: null,
                callback: null
            }, e.config.stepbar, n), l = 0, c = !1;
            function s(n) {
                var l = t.extend(!0, r, n);
                if (l.onBeforeInit && l.onBeforeInit.call(o, l),
                l.id) {
                    i = e.obj(l.id),
                    r = o.config = l;
                    var s, d, f = "function" == typeof l.template ? l.template.call(o, l.data) : (s = l.data,
                    d = "",
                    ...
                    d);
                    if ("x" == r.direction ? i.addClass("bui-stepbar-center bui-stepbar-line") : (i.addClass("bui-stepbar"),
                    i.removeClass("bui-stepbar-center bui-stepbar-line")),
                    l.data.length && i.html(f),
                    o.$el = i,
                    a = i.children(),
                    c || function(e) {
                        var n = function(n) {
            ...
            function u(e, n) {
                return n = n || "",
                /\d/.test(e) ? (e = e >= a.length - 1 ? a.length - 1 : e < 0 ? 0 : e,
                a.each((function(i, a) {
                ...
                e != l && (f.call(o, "change", e),
                r.onChange && r.onChange.call(o, e),
                l = e),
                e) : e = i.children(".active").index()
            }
            function d(t, n) {
                return e.off.apply(o, arguments),
                this
    ...
    var n = function(e) {
        ...
        function l(e, t) {
            ...
            o = new WebKitCSSMatrix("none" === i ? "" : i)) : n = (o = a.MozTransform || a.OTransform || a.MsTransform || a.msTransform || a.transform || a.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
        ...
        t.cols = [],
        t.initialized = !1;
        var c, s, u, d, f, p, h = (c = navigator.userAgent,
        s = c.match(/(Android);?[\s\/]+([\d.]+)?/),
        u = c.match(/(iPad).*OS\s([\d_]+)/),
        d = c.match(/(iPod)(.*OS\s([\d_]+))?/),
        f = !u && c.match(/(iPhone\sOS)\s([\d_]+)/),
        p = !!s,
        u || d || f || navigator.userAgent.toLowerCase().indexOf("safari") >= 0 && navigator.userAgent.toLowerCase().indexOf("chrome") < 0 && !p);
        return t.setValue = function(e, n) {
            var i = 0;
            if (0 === t.cols.length)
                return t.value = e,
                void t.updateValue(e);
            for (var a = 0; a < t.cols.length; a++)
                t.cols[a] && !t.cols[a].divider && (t.cols[a].setValue(e[i], n),
                i++)
        }
        ,
        t.updateValue = function(e) {
            for (var n = e || [], i = [], a = 0; a < t.cols.length; a++)
                t.cols[a].divider || (n.push(t.cols[a].value),
                i.push(t.cols[a].displayValue));
            n.indexOf(void 0) >= 0 || (t.value = n,
            t.displayValue = i,
            t.params.onChange && t.params.onChange(t, t.value, t.displayValue))
        }
        ,
        t.initPickerCol = function(e, n) {
            ...
            if (!s.divider) {
                ...
                s.calcSize = function() {
                    var e, n;
                    t.params.rotateEffect && (s.container.removeClass("picker-items-col-absolute"),
                    s.width || (s.container[0].style.width = "")),
                    e = 0,
                    ...
                    s.container[0].style.width = e + 2 + "px"),
                    s.container.addClass("picker-items-col-absolute"))
                }
                ,
                s.calcSize(),
                ...
                s.updateItems = function(e, n, i, a) {
                    ...
                    (a || void 0 === a) && (s.value = d.attr("data-picker-value"),
                    s.displayValue = s.displayValues ? s.displayValues[e] : s.value,
                    c != e && (s.onChange && s.onChange(t, s.value, s.displayValue),
                    t.updateValue()))
                }
                ,
            ...
            function S(e) {
                if (m) {
                    ...
                    n.preventDefault(),
                    k = void 0,
                    (I = x + (y - b)) < f && (I = f - Math.pow(f - I, .8),
                    k = "min"),
                    I > p && (I = p + Math.pow(I - p, .8),
                    k = "max"),
        ...
        t.columnHTML = function(e, t) {
            var n = ""
              , i = "";
            if (e.divider)
                i += '<div class="picker-items-col picker-items-col-divider ' + (e.textAlign ? "picker-items-col-" + e.textAlign : "") + " " + (e.cssClass || "") + '">' + e.content + "</div>";
            else {
        ...
        ,
        t.init = function() {
            t.initialized || (t.layout(),
            t.container = $(t.pickerHTML),
            t.container.addClass("picker-modal-inline"),
            $(t.params.container).html(t.container),
            t.container.find(".picker-items-col").each((function() {
                var e = !0;
                (!t.initialized && t.params.value || t.initialized && t.value) && (e = !1),
    ...
    function(e, t) {
        e.pickerdate = function() {
            ...
            function i(i) {
                var a, o, r, l, c, s, u, d, f, p, h, g = e.guid(), m = {
                    id: g,
                    title: "",
                    uid: "",
                    height: 260,
                    ...
                    callback: null
                }, v = null, b = this, y = function() {}, w = null, x = t.extend(!0, {}, m, i);
                ...
                x.callback = function(e) {
                    ...
                    if (!1 === o)
                        return !1;
                    if (1 == o || void 0 === o)
                        if ("取消" == t(e.target).text().trim() || "cancel" == t(e.target).text().trim() || "关闭" == t(e.target).text().trim())
                            try {
                                var r = n(a);
                                b.value(r)
                            } catch (e) {}
                            ...
                            a = b.value(),
                            v && v[0] && "INPUT" === v[0].nodeName ? (v.val(a),
                            v.trigger(x.modelEvent)) : v && v.text(a);
                    v = null
                }
                ;
                var k = {}
                ...
                this.cols = function(e) {
                    ...
                    b.picker && (b.picker.params.cols = f,
                    b.picker.initialized = !1,
                    b.picker.init()),
                    this
                }
                ,
                ...
                ,
                this.reset = function() {
                    return b.picker && (b.picker.initialized = !1,
                    b.picker.init()),
                    this
                }
                ,
                ...
                this.handler = function(t) {
                    return t && o !== t && (o = t,
                    i.handleParent ? e.$(i.handleParent).off("click.bui", o).on("click.bui", o, j) : e.$(o).off("click.bui").on("click.bui", j),
                    j.hasOpen = !1,
                    o = t),
                    this
                }
                ...
                this.formatDate = function(e, t) {
                    ...
                    a)
                        new RegExp("(" + o + ")").test(t) && (t = t.replace(RegExp.$1, 1 == RegExp.$1.length ? a[o] : ("00" + a[o]).substr(("" + a[o]).length)));
                    return t
                }
                ,
                this.onChange = function(t) {
                    var n = this;
                    return s = x.bindValue ? function(i) {
                ...
                this.popup = function(n) {
                    if (n.popup && !w) {
                        ...
                        n.buttons && n.buttons.length && (i += '<div class="bui-dialog-foot bui-box">',
                        t.each(n.buttons, (function(e, t) {
                ...
                var E = function(e, t, n) {
                    var i = P(e.cols)
                      ...
                      , s = r.getTime()
                      , u = l.getTime();
                    return c < s && i["get" + t]() < a ? ("Month" == t && (a += 1),
                    void e.cols[k[t]].setValue(a)) : c > u && i["get" + t]() > o ? ("Month" == t && (o += 1),
                    void e.cols[k[t]].setValue(o)) : void (n && (c < s || c > u) && e.cols[k[n]].onChange(e))
                }
                  , N = {};
                function B(t) {
                ...
                N.FullYear = function(e) {
                    return {
                        ...
                        values: (e = e || {
                            values: function() {
                                for (var e = [], t = r.getFullYear(), n = l.getFullYear(), i = t; i <= n; i++)
                                    e.push(i);
                                return e
                            }()
                        }).values,
                ...
                N.Month = function(e) {
                    return {
                        ...
                        textAlign: "right",
                        onChange: function(e, t, n) {
                            for (var i = new Date, a = e.cols[k.FullYear] ? e.cols[k.FullYear].value : i.getFullYear(), o = e.cols[k.Month] ? e.cols[k.Month].value : i.getMonth() + 1, r = new Date(a,parseInt(o),0).getDate(), l = [], c = 1; c <= r; c++)
                                l.push(c);
                            var s = e.cols[k.Date];
                ...
                b.init = function(i) {
                    ...
                    b.picker = e.picker({
                        ...
                        value: S(m.value ? n(m.value) : (o = r,
                        p = l,
                        g = new Date,
                        g.getTime() < o.getTime() ? o : g.getTime() > p.getTime() ? p : g)),
                        onChange: function(e, t, n) {
                            var i = u(e, t, n);
                            h != i && (h = i,
                            s && s.call(b, i),
                            B.call(this, "change", i))
                        },
                        cols: f
                    });
                    var v = m.uid;
                    m.popup && !w && (delete m.uid,
                    (w = e.dialog.call(b, m)) && w.on("open", (function() {
                        a = u(b.picker, b.value, b.displayValue),
                        b.picker && (b.picker.initialized = !1,
                        b.picker.init()),
                        B.call(b, "show")
                    }
                    )),
    ...
    function(e, t) {
        e.levelselect = function(n) {
              ...
              , y = {
                ...
                reset: function() {
                    return h.forEach((function(e, t) {
                        e.value(""),
                        0 == t ? (C(t, i.placeholder),
                        e.text(i.placeholder),
                        d && d.to(t)) : (C(t, ""),
                        e.text(""))
                    }
                    )),
            ...
            function x(n) {
                var x = i = y.config = t.extend(!0, {}, i, n);
                ...
                var L = 0
                  , E = function() {
                    ...
                    function i(e) {
                        var n = t(this).index()
                          , i = d && d.index() || 0;
                        1 == x.visibleNum ? d && d.to(n) : (n > i ? d && d.next() : d && d.prev(),
                    ...
                    h[n].on("change", (function(i) {
                        ...
                        1 == x.visibleNum && (x.log && console.log("next"),
                        d.next()),
                        x.popup && !b.isOpen() || (n == x.level - 1 ? (x.log && console.log("close"),
                        x.autoClose && b && b.close()) : 0 != n && (x.log && console.log("next"),
                        d.next()))
                    }
                    )),
                    m[n].on("click.bui", i),
            ...
            function T(t) {
                ...
                t && "array" === e.typeof(t) ? t.forEach((function(e, t) {
                    "string" == typeof e ? h[t].value(e) : "object" === _typeof(e) && (h[t].text(e.name || ""),
                    h[t].value(e.value || ""))
                }
            ...
            function P(e) {
                var t = ""
                  , n = 0;
                if (e.popup || (t += '<div id="' + o + '" class="bui-levelselect">'),
                e.showValue) {
                    for (t += '    <div class="bui-box select-value">',
                    n = 0; n < e.level; n++)
                        t += '        <div class="select-level-val-' + n + '"></div>';
                    t += "    </div>"
                }
                for (t += '<div id="' + r + '" class="bui-tab bui-levelselect-tab">',
                t += '    <div class="bui-tab-main">',
                t += "        <ul>",
                n = 0; n < e.level; n++)
                    t += "            <li>",
    ...
    t((function(e) {
        !function(t, n) {
            t.tab = function(i) {
                ...
                (o = function(e) {
                    r = n.extend(!0, e.data),
                    e.data && (e.menu = ".".concat(l, "-menu"),
                    e.children = ".".concat(l, "-main"),
                    i = r,
                    o = (a.template || p)(i),
                    t.$(a.id).html(o),
                    e.data = null);
                ...
                return o.add = function(e) {
                    ...
                    if (i.menuTemplate = e && e.menuTemplate || i.title && f(i) || "",
                    i.needRemove && !u) {
                        var a = t.obj(this.config.id)
                          , r = this.config;
                        (r.menu.indexOf("#") > -1 ? t.obj(r.menu) : a.find(r.menu).eq(0)).off("click.bui", ".icon-close").on("click.bui", ".icon-close", (function(e) {
    ...
    function(e, t) {
        e.input = function(n) {
            var i, a, o, r, l, c = {
                ...
                onInited: null,
                callback: null
            }, e.config.searchbar, n), u = !1;
            function d(n) {
                var d = t.extend(!0, s, n);
                if (d.onBeforeInit && d.onBeforeInit.call(c, d),
                s = c.config = d,
                "" != d.id && null !== d.id) {
                    if (i = e.obj(d.id),
                    c.$el = i,
                    l = i.find(d.target),
                    a = l.eq(0),
                    o = e.unit.startWithClass(d.iconClass) ? d.iconClass : "." + d.iconClass,
                    !u) {
                        if (function(e) {
                            var n = !1;
                            l.on(e.event, (function(i) {
                                var a = this.value
                                  , s = t(this).parent()
                                  , u = s.find(o);
                                a.length > 0 && e.showIcon ? u && u.length ? u.css("display", "block") : (s.append('<i class="' + o.replace(/\./g, " ").substr(1) + '"></i>'),
                                u = l.find(o)) : u && u.css("display", "none"),
                                e.showLength && (r = s.find("em")).text(a.length),
                                n || (e.onInput && e.onInput.call(c, i),
                                f.call(c, "input", i))
                            }
                            ...
                            e.onFocus && l.off("focus").on("focus", (function(n) {
                                var r = this.value;
                                a = t(this),
                                e.showIcon && (i.find(o).css("display", "none"),
                                r && t(this).next().css("display", "block")),
                                e.onFocus.call(c, n),
                                f.call(c, "focus", n)
                            }
                            )),
    ...
    function(e, t) {
        e.extend({
            ...
            callback: function(n) {
                    ...
                    s || function(e) {
                        var n = function(n) {
                            if (c) {
                                ...
                                0 === a && (n.index = 0,
                                i.trigger("scrolltop", n),
                                e.onScrollTop && e.onScrollTop.call(i, n)),
                                a > 5 && u && (i.getSelector(e),
                                g(),
                                u = !1);
                                ...
                                for (l = 0; l < h.length; l++) {
                                    ...
                                    if (s.top > -1) {
                                        var d = s.top - a;
                                        if (s.top == a && 0 == a)
                                            return r && r.removeClass("active"),
                                            r && r.eq(l).addClass("active"),
                                            n.index = l,
                                            void i.trigger("scrollto", n);
                                        d < o && (r && r.removeClass("active"),
                                        r && r.eq(l).addClass("active"),
                                        n.index = l,
                                        i.trigger("scrollto", n))
                                    }
                                }
                                parseInt(a + this.offsetHeight, 10) == parseInt(this.scrollHeight, 10) && (n.index = h.length - 1,
                                i.trigger("scrollbottom", n),
                                e.onScrollBottom && e.onScrollBottom.call(i, n))
                            }
                            i.trigger("scroll", n),
                ...
                ,
                i.resize = function(n) {
                    if (this.getSelector(n),
                    "string" == typeof n.height && "inherit" !== n.height) {
                        ...
                        "number" == typeof n.height && n.height > 0 ? (a.height(n.height).css("position", "relative"),
                        p = n.height) : p = a.height()
                }
                ,
                i.to = function(e, t) {
    ...
    function(e, t) {
        e.ajax = function(n) {
            var i = t.Deferred()
              ...
              , r = o.success
              , l = o.fail || o.error;
            if (null === o.contentType && "get" == o.method.toLocaleLowerCase() ? o.contentType = "text/html;charset=UTF-8" : null === o.contentType && "post" == o.method.toLocaleLowerCase() ? o.contentType = "application/x-www-form-urlencoded" : o.contentType = o.contentType,
            ...
            if (o.data = o.transformRequest && o.transformRequest.call(i, o.data) || o.data,
            !o.url)
                return e.showLog("url不能为空", "bui.ajax"),
                i;
            if (o.url.indexOf("://") > -1 ? o.url = o.url : o.url.indexOf("./") > -1 || o.url.indexOf("../") > -1 ? o.url = bui.unit.resolvePath(o.url) : o.url = o.baseUrl + o.url,
            o.proxy) {
            ...
            ,
            o.localData)
                return o.localData = o.transformResponse && o.transformResponse.call(i, o.localData) || o.localData,
                r && r(o.localData, 200),
                i.resolve(o.localData, 200),
                i;
            if (o.needNative) {
                if (void 0 === e.native.ajax)
                    return u(o),
                    i;
                try {
            ...
            function u(e) {
                e.success = function(t, n, a) {
                    var o = null;
                    if ("string" == typeof t && "json" == e.dataType)
                        try {
                            o = JSON.parse(t)
                        } catch (e) {
                            o = t
        ...
        e.get = function(n, i, a) {
            ...
            var r = null
              , l = a && a[0];
            return r = a && "array" === e.typeof(a) && "object" == e.typeof(l) ? t.extend(!0, {}, e.config.get, o, l) : o,
            bui.ajax(r)
        }
        ,
        e.post = function(n, i, a) {
            ...
            var r = null
              , l = a && a[0];
            return (r = a && "array" === e.typeof(a) && "object" == e.typeof(l) ? t.extend(!0, {}, e.config.post, o, l) : o).contentType.indexOf("application/json") > -1 && (r.data = "object" === _typeof(r.data) ? JSON.stringify(r.data) : r.data),
            bui.ajax(r)
        }
        ,
        e.put = function(n, i, a) {
            ...
            var r = null
              , l = a && a[0];
            return (r = a && "array" === e.typeof(a) && "object" == e.typeof(l) ? t.extend(!0, {}, e.config.put, o, l) : o).contentType.indexOf("application/json") > -1 && (r.data = "object" === _typeof(r.data) ? JSON.stringify(r.data) : r.data),
            bui.ajax(r)
        }
        ,
        e.delete = function(n, i, a) {
            ...
            var r = null
              , l = a && a[0];
            return (r = a && "array" === e.typeof(a) && "object" == e.typeof(l) ? t.extend(!0, {}, e.config.delete, o, l) : o).contentType.indexOf("application/json") > -1 && (r.data = "object" === _typeof(r.data) ? JSON.stringify(r.data) : r.data),
            bui.ajax(r)
        }
        ,
        e.all = function(n) {
    ...
    function(e, t) {
        e.load = function(n) {
            var i, a = {
                ...
                native: !0,
                needNative: !1
            }, o = t.extend(!0, {}, a, e.config.load, n), r = {}, l = o.url;
            if (o.url)
                if (document.activeElement.blur(),
                l.indexOf("tel:") >= 0 || l.indexOf("mailto:") >= 0 || l.indexOf("sms:") >= 0)
                    e.unit.openExtral(l);
                else {
                    if (l && l.indexOf("?") > -1) {
                        var c = l.split("?");
                    ...
                    n && n.needNative || e.nativeRouter ? e.native.load && e.native.load(o) : (i = e.setUrlParams(o.url, o.param),
                    o.reload ? window.location.href = e.hasRouter ? "index.html#" + i : i : !o.replace || e.hasRouter ? e.hasRouter ? window.router.load(o) : window.location.href = i : window.location.replace(i))
                }
            else
                e.showLog("url 不能为空!", "bui.load:web")
        }
    }(window.bui || {}, window.libs),
    function(e, t) {
        e.getPageParams = function(n) {
            ...
            if ("function" == typeof n ? o.callback = n : n && "object" === e.typeof(n) && (o = t.extend(!0, {}, a, e.config.getPageParams, n)),
            "object" === _typeof(n) && void 0 !== n.needNative ? n.needNative : e.isWebapp,
            n && n.needNative || e.nativeRouter)
                return i = e.native.getPageParams && e.native.getPageParams(o) || i;
            if (e.hasRouter) {
    ...
    function(e, t) {
        e.back = function(n) {
            ...
            "function" == typeof n ? (a.callback = n,
            i = t.extend(!0, {}, a, e.config.back)) : i = n && "object" === e.typeof(n) ? t.extend(!0, {}, a, e.config.back, n) : t.extend(!0, {}, a, e.config.back),
            "object" === _typeof(n) && void 0 !== n.needNative ? n.needNative : e.isWebapp;
            ...
            if (!1 !== ("function" == typeof i.beforeBack ? i.beforeBack.call(this, {
                ...
                if (n && n.needNative || e.nativeRouter)
                    e.native.back && e.native.back(i);
                else {
                    if (e.hasRouter)
                        if (window.router.config.syncHistory) {
                            ...
                            if (Math.abs(i.index) >= r.length && (i.index = -l),
                            Math.abs(i.index) >= window.history.length && window.router.config.hash && (i.index = window.router.config.reloadCache ? -l : -(window.history.length - 1)),
                            0 == i.index && (i.index = -1),
                            window.router.config.hash && !window.router.config.reloadCache)
                                return void d();
                            (r.length > 1 || window.history.length > 1) && d()
                        } else
                            window.router.back && window.router.back(i);
                    else
                        d();
                    var u = null
                }
    ...
    function(e, t) {
        e.run = function(n) {
            ...
            var a = String(i.id);
            if ("object" === _typeof(n) && void 0 !== n.needNative ? n.needNative : e.isWebapp,
            n.needNative)
                e.native.run && e.native.run(i);
            else if (a.indexOf("http://") > -1 || a.indexOf("https://") > -1) {
                var o = e.setUrlParams(i.id, i.data);
                if (e.platform.isIos())
                    return void (window.location.href = o);
                (window.open("", "_blank") || window.open("", "_newtab")).location.href = o
            }
        }
    }(window.bui || {}, window.libs),
    function(e, t) {
        e.fileselect = function(n) {
            var i, a, o, r = t.extend(!0, {}, {
                ...
                onFail: null,
                mediaType: "picture"
            }, e.config.fileselect, n), l = this, c = {
                add: function(n) {
                    s = null;
                    var i = t.extend(!0, {
                        needChangeData: !0,
                    ...
                    (u = i).mimeType = n.mimeType ? n.mimeType : "",
                    f ? (n.from ? "picture" === n.from || "photo" === n.from || "savephoto" === n.from ? a.removeAttr("capture") : a.attr("capture", n.from) : a.removeAttr("capture"),
                    e.platform.isIos() && "function" == typeof FastClick ? a[0].dispatchEvent(new Event("click")) : a.trigger("click")) : o.add(i);
                    return this
                },
                remove: function(t, n) {
                    n = n || "name";
                    if (!f)
                        return d = o.remove(t, n);
                    if ("string" == typeof t) {
                ...
                toBase64: function(n) {
                    ...
                    if (i.data = i.data || s,
                    i.mimeType = n.mimeType ? n.mimeType : i.data && i.data.type || "image/jpeg",
                    f)
                        try {
                            w(i)
                        } catch (t) {
                ...
                init: y
            }, s = null, u = null, d = [], f = "object" === _typeof(n) && void 0 !== n.needNative ? !n.needNative : e.isWebapp, p = "*", h = !1, g = null, m = null, v = null, b = null;
            function y(n) {
                var y = t.extend(!0, r, n);
                switch (r.appendTo = y.appendTo || e.hasRouter && router.currentPage() || "body",
                y.mediaType) {
                case "allmedeia":
                    p = "*";
                    break;
                ...
                h || (a.on("change", (function(t) {
                    ...
                    if (!(n.length < 1)) {
                        ...
                        d.push(a),
                        u.needCompress ? (u.data = i,
                        u.mimeType = u.mimeType ? u.mimeType : i.type,
                        w(u)) : u.onSuccess && u.onSuccess.call(l, i, d),
                        this.value = ""
                    }
                }
                )),
            ...
            function w(n) {
                ...
                g.onload = function() {
                    var t = this.width
                      ...
                      , c = t
                      , u = n;
                    i.needCompress && (t > o || n > r) && (t / n > o / r ? (c = o,
                    u = Math.round(o * (n / t))) : (u = r,
                    c = Math.round(r * (t / n)))),
                    v.width = c,
                    v.height = u,
                    b.clearRect(0, 0, c, u),
                    ...
                    if (i.needChangeData) {
                        ...
                        h > -1 && (d[h].data = a,
                        a.size && (d[h].size = a.size),
                        a.type && (d[h].type = a.type))
                    }
            ...
            function x(t, n) {
                try {
                    n = n || "file";
                    for (var i = t.split(","), a = (i[0].match(/:(.*?);/) || [])[1] || "image/jpeg", o = a.split("/")[1], r = atob(i[1]), l = r.length, c = new Uint8Array(l); l--; )
                        c[l] = r.charCodeAt(l);
        ...
        e.file = function(n) {
            ...
            function u(n) {
                ...
                a = function(n) {
                    ...
                    o = 1024 * parseInt(s.size) * 1024,
                    window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem,
                    navigator.webkitPersistentStorage && navigator.webkitPersistentStorage.requestQuota(o, (function(e) {
            ...
            function h(e) {
                var n = t.extend({}, {
                  ...
                  , a = "";
                if (n.create ? (a = "创建 ",
                n.param.create = !0) : (a = "获取 ",
                n.param.create = !1),
                n.fileName && !(n.fileName.indexOf(".") < 0)) {
                    if (s.needNative)
                        l.getFile(n);
                    else {
                        var o = p(n.fileName);
    ...
    function(e, t) {
        e.upload = function(n) {
            var i, a, o, r, l, c, s, u = {
                ...
                onSuccess: null,
                onFail: null
            }, d = t.extend(!0, {}, u, e.config.upload, n), f = t.Deferred(), p = {
                init: m,
                add: function(e) {
                ...
                startAll: function(e) {
                    ...
                    for (var o = [], r = 0; r < i.length; r++)
                        ...
                        function(e) {
                            if (!(e > i.length - 1)) {
                                if (n.data[n.fileKey] = i[e] && i[e].data,
                                n.needFileinfo)
                                    for (var t in i[e])
                                        "data" !== t && (n.data[t] = i[e] && i[e][t]);
                                var a = n.onSuccess
                                  , r = n.onFail;
            ...
            }, h = d.showProgress, g = d.onProgress;
            function m(t) {
                return i = e.loading({
                    display: "block",
                    width: 30,
                    ...
                    function(e) {
                        ...
                        return o = t.ajax({
                            ...
                            xhr: function() {
                                ...
                                if (w && e.upload)
                                    return e.upload.addEventListener("progress", w, !1),
                                    e
                            },
                            success: function(e) {
                                x(),
            ...
            function y(e) {
                return d && d.needNative ? r.stop(e) : (i && i.stop(),
                o && o.abort(),
                e && e.call(p, i, o)),
                this
            }
        ...
        e.download = function(n) {
            var i, a, o, r, l, c = {
                ...
                removeFile: function(t) {
                    if (!t.fileName)
                        return e.showLog("请告诉我们你要删除哪个文件, fileName "),
                        this;
                ...
                onSuccess: null,
                onFail: null
            }, e.config.download, n), u = "object" === _typeof(n) && void 0 !== n.needNative ? !n.needNative : e.isWebapp, d = s.showProgress, f = s.onProgress, p = s.onFail, h = null, g = null;
            function m(t) {
            ...
            function v(e) {
                ...
                n.needNative ? o.start(n) : (n.cache = !1,
                n.contentType = !1,
                n.processData = !1,
                i = t.ajax({
                    url: r,
                    ...
                    xhr: function() {
                        var e = t.ajaxSettings.xhr();
                        if (y && e)
                            return e.addEventListener("progress", y, !1),
                            e
                    },
                    success: function(t) {
            ...
            function b(e) {
                u ? (w(),
                i && i.abort(),
                g && window.cancelAnimationFrame(g)) : o.stop(),
                e && e.call(c, h, i)
            }
            function y(e) {
                window.requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame,
    ...
    function(e, t) {
        ...
        e.ready = function(n) {
            ...
            if (e.isWebapp)
                ...
                if (void 0 === e.native.ready)
                    return e.showLog("当前 bui.isWebapp = false; 但bui.js为webapp版本,不支持原生方法,请使用 buijs update -p xxx, 更换bui.js为对应xxx平台版本;"),
                    e.webready(n),
                    i;
    ...
    function(e, t) {
        e.init = function(n) {
            ...
            if ("object" == e.typeof(n))
                i = t.extend({}, a, e.config.init, n);
            else {
                var o = {};
                o.height = n,
                i = t.extend({}, a, o)
